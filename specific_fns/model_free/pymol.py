...
class Pymol:
    ...
    def _pymol_classic_style(self, data_type=None, colour_start=None, colour_end=None, colour_list=None, spin_id=None):
        ...
        for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
            ...
            if prev_res_num == res_num:
                raise RelaxError("Only a single spin per residue is allowed for the classic Pymol macro style.")
        ...
        if data_type == 'S2':
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # S2 width and colour.
                self._pymol_classic_order_param(res_num, spin.s2, colour_start, colour_end, colour_list)
        ...
        ######
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                if not hasattr(spin, 's2f') or spin.s2f == None:
                    self._pymol_classic_colour(res_num=res_num, width=0.3, rgb_array=[1, 1, 1])

                # S2f width and colour.
                else:
                    self._pymol_classic_order_param(res_num, spin.s2f, colour_start, colour_end, colour_list)
        ...
        ######
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # S2s width and colour.
                    ...
                    self._pymol_classic_order_param(res_num, spin.s2s, colour_start, colour_end, colour_list)
        ...
        #####
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # te width and colour.
                self._pymol_classic_correlation_time(res_num, spin.te, colour_start, colour_end, colour_list)
        ...
        #####
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # tf width and colour.
                self._pymol_classic_correlation_time(res_num, spin.tf, colour_start, colour_end, colour_list)
        ...
        #####
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # ts width and colour.
                self._pymol_classic_correlation_time(res_num, spin.ts / 10.0, colour_start, colour_end, colour_list)
        ...
        ############################
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                # te width and colour (for models m2 and m4 when te > 200 ps).
                    ...
                    self._pymol_classic_correlation_time(res_num, spin.te / 10.0, colour_start, colour_end, colour_list)
        ...
        ######
            ...
            for spin, mol_name, res_num, res_name in spin_loop(spin_id, full_info=True):
                ...
                if hasattr(spin, 'rex') and spin.rex != None:
                    self._pymol_classic_rex(res_num, spin.rex, colour_start, colour_end, colour_list)
    ...
    def _pymol_classic_rex(self, res_num, rex, colour_start, colour_end, colour_list):
        """Function for generating the bond width and colours for correlation times."""
    ...
    def pymol_macro(self, data_type, style=None, colour_start=None, colour_end=None, colour_list=None, spin_id=None):
        """Create and return an array of Pymol macros of the model-free parameters.
        ...
        # The classic style.
        if style == 'classic':
            self._pymol_classic_style(data_type, colour_start, colour_end, colour_list, spin_id)
