...
def pcs_numeric_int_iso_cone_qrint(points=None, max_points=None, theta_max=None, sigma_max=None, c=None, full_in_ref_frame=None, r_pivot_atom=None, r_pivot_atom_rev=None, r_ln_pivot=None, A=None, R_eigen=None, RT_eigen=None, Ri_prime=None, pcs_theta=None, pcs_theta_err=None, missing_pcs=None):
    ...
    @keyword Ri_prime:          The array of pre-calculated rotation matrices for the in-frame isotropic cone motion, used to calculate the PCS for each state i in the numerical integration.
