...
# C modules.
if C_module_exp_fn:
    from target_functions.relax_fit import back_calc_I, d2func_exp, d2func_sat, dfunc_exp, dfunc_sat, func_exp, func_sat, jacobian_chi2_exp, jacobian_chi2_sat, jacobian_exp, jacobian_sat, setup 
