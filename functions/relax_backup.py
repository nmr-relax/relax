	...
	def Ri(self, options, mf_values):
		...
		for i in range(self.mf.data.num_ri):
			if self.mf.data.frq[self.mf.data.remap_table[i]] != last_frq:
				...
				#for frq in range(len(self.mf.usr_param.nmr_frq)):
				#	if match(self.options[4][i], self.mf.usr_param.nmr_frq[frq][0]):
				#		self.frq = self.mf.usr_param.nmr_frq[frq][1]
				#		self.frq_num = frq
				#self.j = []
				...
				#		self.dj[param].append(self.mf.functions.jw.dJ(self.options, self.mf.data.frq[self.frq_num][0], self.mf_values, self.param_types[param]))
				#		self.dj[param].append(self.mf.functions.jw.dJ(self.options, self.mf.data.frq[self.frq_num][1], self.mf_values, self.param_types[param]))
				#		self.dj[param].append(self.mf.functions.jw.dJ(self.options, self.mf.data.frq[self.frq_num][2], self.mf_values, self.param_types[param]))
				#		self.dj[param].append(self.mf.functions.jw.dJ(self.options, self.mf.data.frq[self.frq_num][3], self.mf_values, self.param_types[param]))
				#		self.dj[param].append(self.mf.functions.jw.dJ(self.options, self.mf.data.frq[self.frq_num][4], self.mf_values, self.param_types[param]))
