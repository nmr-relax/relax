...
class Monte_carlo:
    ...
    def create_data(self, run=None, method='back_calc'):
        """Function for creating the data used by the simulations.
        ...
        deviation is the original data error.  If the method is set to 'back_calc', this function
        should only be called after the model or run is fully minimised.
        ...
        noise with the standard deviations set to the original data errors.
        """
    ...
    def setup(self, run=None, number=500):
        """Function for setting up Monte Carlo simulations for error analysis.
        ...
        A full description of Monte Carlo simulations is given at the end.

        Simulations can be turned on or off using functions within this class.  Once this function
        is called, simulations are turned on.  The effect of simulations being on is that the
        functions used in minimisation (grid search, minimise, etc) will only minimise the
        simulations and not the model parameters.  By subsequently turning simulations off using the
        appropriate function, the functions used in minimisation will minimise the model parameters
        and not the simulation parameters.
        """
