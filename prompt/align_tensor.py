...
class Align_tensor(User_fn_class):
    ...
    def copy(self, tensor_from=None, pipe_from=None, tensor_to=None, pipe_to=None):
        ...
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.copy("
    ...
    def delete(self, tensor=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.delete("
    ...
    def display(self, tensor=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.display("
            text = text + "tensor=" + repr(tensor) + ")"
            print(text)
    ...
    def fix(self, id=None, fixed=True):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.fix("
    ...
    def init(self, tensor=None, params=None, scale=1.0, angle_units='deg', param_types=0, errors=False):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.init("
            text = text + "tensor=" + repr(tensor)
    ...
    def matrix_angles(self, basis_set=0, tensors=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.matrix_angles("
    ...
    def reduction(self, full_tensor=None, red_tensor=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.reduction("
    ...
    def set_domain(self, tensor=None, domain=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.set_domain("
            text = text + "tensor=" + repr(tensor)
    ...
    def svd(self, basis_set=0, tensors=None):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "align_tensor.svd("
            text = text + "basis_set=" + repr(basis_set)
            text = text + ", tensors=" + repr(tensors) + ")"
            print(text)
