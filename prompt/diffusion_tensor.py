...
class Diffusion_tensor(User_fn_class):
    ...
    def copy(self, pipe_from=None, pipe_to=None):
        ...
        if status.prompt_intro:
            text = status.ps3 + "diffusion_tensor.copy("
    ...
    def delete(self):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "diffusion_tensor.delete()"
            print(text)
    ...
    def display(self):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "diffusion_tensor.display()"
            print(text)
    ...
    def init(self, params=None, time_scale=1.0, d_scale=1.0, angle_units='deg', param_types=0, spheroid_type=None, fixed=True):
        ...
        # Function intro text.
        if status.prompt_intro:
            text = status.ps3 + "diffusion_tensor.init("
