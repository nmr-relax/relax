...
class Dasha:
    ...
    def create(self, run=None, dir=None, force=0, diff_search='none', sims=0, trim=0, steps=20, constraints=1, nucleus='15N', atom1='N', atom2='H'):
        ...
        self.__relax__.generic.dasha.create(run=run, dir=dir, force=force, diff_search=diff_search, sims=sims, sim_type=sim_type, trim=trim, steps=steps, constraints=constraints, nucleus=nucleus, atom1=atom1, atom2=atom2)
