...
class Structure:
    ...
    def load_spins(self, spin_id=None, ave=True):
        ...
        ave:  A flag specifying if the position of the atom is to be averaged.
        ...
        If the ave flag is True, the average position of all structures will be loaded into the spin
