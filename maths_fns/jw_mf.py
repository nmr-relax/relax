...
def calc_diff_d2jw_dDjdDk(data, params, j, k, num_D_params):
    ...
    return -0.4 * sum(data.ci * (2 * data.ti * data.frq_sqrd_list_ext * (3.0 - data.w_ti_sqrd) * data.dti[j] * data.dti[k] - (1.0 - data.frq_sqrd_list_ext**2) * data.d2ti[j, k]) * data.fact_ti**3, axis=2)
...
def calc_diff_S2_d2jw_dDjdDk(data, params, j, k, num_D_params):
    ...
    return -0.4 * params[data.s2_index] * sum(data.ci * (2 * data.ti * data.frq_sqrd_list_ext * (3.0 - data.w_ti_sqrd) * data.dti[j] * data.dti[k] - (1.0 - data.frq_sqrd_list_ext**2) * data.d2ti[j, k]) * data.fact_ti**3, axis=2)
...
def calc_diff_S2_te_d2jw_dDjdDk(data, params, j, k, num_D_params):
    ...
    # ti.
    fact_ti = params[data.s2_index] * (2 * data.ti * data.frq_sqrd_list_ext * (3.0 - data.w_ti_sqrd) * data.dti[j] * data.dti[k] - (1.0 - data.frq_sqrd_list_ext**2) * data.d2ti[j, k]) * data.fact_ti**3
...
def calc_diff_S2f_S2_ts_d2jw_dDjdDk(data, params, j, k, num_D_params):
    ...
    # ti.
    fact_ti = params[data.s2_index] * (2 * data.ti * data.frq_sqrd_list_ext * (3.0 - data.w_ti_sqrd) * data.dti * data.dti - (1.0 - data.frq_sqrd_list_ext**2) * data.d2ti) * data.fact_ti**3

    # ts.
    fact_ts = 2.0 * (data.ts_ti**3 + 3.0 * data.frq_sqrd_list_ext * params[data.ts_index]**3 * data.ti * data.ts_ti - (data.frq_list_ext * params[data.ts_index])**4 * data.ti**3) * data.dti * data.dti  +  (data.ts_ti**4 - data.w_ts_ti_sqrd**2) * data.d2ti
...
def calc_diff_S2f_tf_S2_ts_d2jw_dDjdDk(data, params, j, k, num_D_params):
    ...
    # tf.
    fact_tf = 2.0 * (data.tf_ti**3 + 3.0 * data.frq_sqrd_list_ext * params[data.tf_index]**3 * data.ti * data.tf_ti - (data.frq_list_ext * params[data.tf_index])**4 * data.ti**3) * data.dti * data.dti  +  (data.tf_ti**4 - data.w_tf_ti_sqrd**2) * data.d2ti
...
def calc_diff_S2f_S2_ts_d2jw_dDjdS2(data, params, j, k, num_D_params):
    ...
    return 0.4 * sum(data.ci * data.dti * (data.fact_ti_djw_dti - data.fact_ts_djw_dti), axis=2)
...
def calc_diff_S2f_S2_ts_d2jw_dDjdS2f(data, params, j, k, num_D_params):
    ...
    return 0.4 * sum(data.ci * data.dti * data.fact_ts_djw_dti, axis=2)
...
def calc_diff_S2f_tf_S2_ts_d2jw_dDjdS2f(data, params, j, k, num_D_params):
    ...
    return -0.4 * sum(data.ci * data.dti * (data.fact_tf_djw_dti - data.fact_ts_djw_dti), axis=2)
...
def calc_S2f_tf_S2_ts_d2jw_dtf2(data, params, j, k, num_D_params):
    ...
    num = data.tf_ti**3 + 3.0 * data.ti**3 * params[data.tf_index] * data.frq_sqrd_list_ext * data.tf_ti - data.w_ti_sqrd**2 * params[data.tf_index]**3
...
def calc_S2f_S2s_ts_d2jw_dts2(data, params, j, k, num_D_params):
    ...
    num = data.ts_tm**3 + 3.0 * data.ti**3 * params[data.ts_index] * data.frq_sqrd_list_ext * data.ts_tm - data.w_tm_sqrd**2 * params[data.ts_index]**3
...
def calc_S2f_tf_S2s_ts_d2jw_dS2fdS2s(data, params, j, k, num_D_params):
    """Spectral density Hessian.
...
def calc_S2f_tf_S2s_ts_d2jw_dS2fdts(data, params, j, k, num_D_params):
    """Spectral density Hessian.
...
def calc_S2f_tf_S2s_ts_d2jw_dS2sdts(data, params, j, k, num_D_params):
    """Spectral density Hessian.
...
def calc_S2f_tf_S2s_ts_d2jw_dtf2(data, params, j, k, num_D_params):
    ...
    num = data.tf_tm**3 + 3.0 * data.ti**3 * params[data.tf_index] * data.frq_sqrd_list_ext * data.tf_tm - data.w_tm_sqrd**2 * params[data.tf_index]**3
    return -2.0*data.two_fifths_tm_sqrd * data.one_s2f * num * data.inv_tf_denom**3


def calc_S2f_tf_S2s_ts_d2jw_dts2(data, params, j, k, num_D_params):
    """Spectral density Hessian.
