...
class Fetch_docstrings:
    ...
    def index_entries(self):
        ...
        self.entries.append(['BFGS', 'optimisation!BFGS algorithm'])
        ...
        self.entries.append(['cauchy', 'optimisation!Cauchy point algorithm'])
        self.entries.append(['CG-Steihaug', 'optimisation!CG-Steihaug algorithm'])
        ...
        self.entries.append(['conjugate gradient', 'optimisation!conjugate gradient algorithm'])
        ...
        self.entries.append(['dogleg', 'optimisation!dogleg algorithm'])
        ...
        self.entries.append(['exact trust region', 'optimisation!exact trust region algorithm'])

        self.entries.append(['Fletcher-Reeves', 'optimisation!Fletcher-Reeves algorithm'])
        ...
        self.entries.append(['Hestenes-Stiefel', 'optimisation!Hestenes-Stiefel algorithm'])
        ...
        self.entries.append(['Levenberg-Marquardt', 'optimisation!Levenberg-Marquardt algorithm'])
        self.entries.append(['limit', 'parameter!limit'])

        self.entries.append(['map', 'map'])
        self.entries.append(['method of [Mm]ultipliers', 'optimisation!Method of Multipliers algorithm'])
        ...
        self.entries.append(['newton', 'optimisation!Newton algorithm'])
        self.entries.append(['newton-CG', 'optimisation!Newton conjugate gradient algorithm'])
        self.entries.append(['NMR', 'NMR'])

        self.entries.append(['PDB', 'PDB'])
        self.entries.append(['Polak-Ribi.*re', 'optimisation!Polak-Ribiere@Polak-Ribi\`ere algorithm'])
        self.entries.append(['Polak-Ribi.*re +', 'optimisation!Polak-Ribiere@Polak-Ribi\`ere + algorithm'])
        ...
        self.entries.append(['simplex', 'optimisation!Nelder-Mead simplex algorithm'])
        ...
        self.entries.append(['Sparky', 'software!Sparky'])
        self.entries.append(['steepest descent', 'optimisation!steepest descent algorithm'])
