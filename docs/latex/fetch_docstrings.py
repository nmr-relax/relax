...
class Fetch_docstrings:
    ...
    def index_entries(self):
        ...
        self.entries.append(['BFGS', 'minimisation algorithm!BFGS'])
        ...
        self.entries.append(['cauchy', 'minimisation algorithm!Cauchy point'])
        self.entries.append(['CG-Steihaug', 'minimisation algorithm!CG-Steihaug'])
        ...
        self.entries.append(['conjugate gradient', 'minimisation algorithm!conjugate gradient'])
        ...
        self.entries.append(['dogleg', 'minimisation algorithm!dogleg'])
        ...
        self.entries.append(['exact trust region', 'minimisation algorithm!exact trust region'])

        self.entries.append(['Fletcher-Reeves', 'minimisation algorithm!Fletcher-Reeves'])
        ...
        self.entries.append(['Hestenes-Stiefel', 'minimisation algorithm!Hestenes-Stiefel'])
        ...
        self.entries.append(['Levenberg-Marquardt', 'minimisation algorithm!Levenberg-Marquardt'])
        self.entries.append(['limit', 'parameter!limit'])

        self.entries.append(['map', 'map'])
        self.entries.append(['method of [Mm]ultipliers', 'minimisation algorithm!Method of Multipliers'])
        ...
        self.entries.append(['newton', 'minimisation algorithm!Newton'])
        self.entries.append(['newton-CG', 'minimisation algorithm!Newton conjugate gradient'])
        self.entries.append(['NMR', 'NMR'])

        self.entries.append(['PDB', 'PDB'])
        self.entries.append(['Polak-Ribi.*re', 'minimisation algorithm!Polak-Ribiere@Polak-Ribi\`ere'])
        self.entries.append(['Polak-Ribi.*re +', 'minimisation algorithm!Polak-Ribiere@Polak-Ribi\`ere +'])
        ...
        self.entries.append(['simplex', 'minimisation algorithm!Nelder-Mead simplex'])
        ...
        self.entries.append(['Sparky', 'software!Sparky'])
        self.entries.append(['steepest descent', 'minimisation algorithm!steepest descent'])
