###############################################################################
#                                                                             #
# Copyright (C) 2005-2006,2008-2009,2012-2014 Edward d'Auvergne               #
#                                                                             #
...
class Fetch_docstrings:
    ...
    def index_entries(self):
        ...
        self.entries.append(['BFGS', 'optimisation!algorithm!BFGS'])
        ...
        self.entries.append(['cauchy', 'optimisation!algorithm!Cauchy point'])
        self.entries.append(['CG-Steihaug', 'optimisation!algorithm!CG-Steihaug'])
        ...
        self.entries.append(['conjugate gradient', 'optimisation!algorithm!conjugate gradient'])
        ...
        self.entries.append(['dogleg', 'optimisation!algorithm!dogleg'])
        ...
        self.entries.append(['exact trust region', 'optimisation!algorithm!exact trust region'])

        self.entries.append(['Fletcher-Reeves', 'optimisation!algorithm!Fletcher-Reeves'])
        ...
        self.entries.append(['Hestenes-Stiefel', 'optimisation!algorithm!Hestenes-Stiefel'])
        ...
        self.entries.append(['Levenberg-Marquardt', 'optimisation!algorithm!Levenberg-Marquardt'])
        self.entries.append(['limit', 'parameter!limit'])

        self.entries.append(['map', 'map'])
        self.entries.append(['method of [Mm]ultipliers', 'optimisation!constraint algorithm!Method of Multipliers'])
        self.entries.append(['minimise', 'optimisation'])
        self.entries.append(['minimisation', 'optimisation'])
        ...
        self.entries.append(['newton', 'optimisation!algorithm!Newton'])
        self.entries.append(['newton-CG', 'optimisation!algorithm!Newton conjugate gradient'])
        self.entries.append(['NMR', 'NMR'])

        self.entries.append(['PDB', 'PDB'])
        self.entries.append(['Polak-Ribi.*re', 'optimisation!algorithm!Polak-Ribiere@Polak-Ribi\`ere'])
        self.entries.append(['Polak-Ribi.*re +', 'optimisation!algorithm!Polak-Ribiere@Polak-Ribi\`ere +'])
        ...
        self.entries.append(['simplex', 'optimisation!algorithm!Nelder-Mead simplex'])
        ...
        self.entries.append(['Sparky', 'software!Sparky'])
        self.entries.append(['steepest descent', 'optimisation!algorithm!steepest descent'])
