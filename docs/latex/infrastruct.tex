...
\section{History} \label{sect: infrastructure history}
...
The contents of the relax repository can be viewed online at \url{\relaxCodeWebInterfaceURL}.
The current sources can be downloaded using the git protocol by typing

\example{\$ git clone \relaxCodeURL\ relax}
\index{git!clone}

In addition there is a git repository for the \href{relaxWebsiteWebInterfaceURL}{relax website} and a git repository for the relax \href{\relaxDemoWebInterfaceURL}{demonstration files}.
