...
MMQ 3-site linear        & Numeric  & 3     & $\{\Rtwozero, \dots, \pA, \pB, \dwAB, \dwBC,$       & $\pA > \pB$ and $\pB > \pC$       & \citet{Korzhnev05} \\
                         &          &       & $\dwHAB, \dwHBC, \kexAB, \kexBC\}$ \\
MMQ 3-site               & Numeric  & 3     & $\{\Rtwozero, \dots, \pA, \pB, \dwAB, \dwBC$        & $\pA > \pB$ and $\pB > \pC$       & \citet{Korzhnev05} \\
