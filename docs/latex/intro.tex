...
You will need to replace \file{your\_script.py} with the name of your script.  An example of a simple script which will minimise the model-free model ``m4'' after loading six relaxation data sets is
