%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                             %
% Copyright (C) 2005-2006,2008,2012-2015,2018-2019 Edward d'Auvergne          %
%                                                                             %
...
\newcommand{\relaxHome}{SourceForge}
\newcommand{\relaxHomeRegisterURL}{https://sourceforge.net/user/registration}
\newcommand{\relaxHomeRemoteName}{sf}
\newcommand{\relaxMirrorBBCodeWebInterfaceURL}{https://bitbucket.org/nmr-relax/relax/src/master/}
\newcommand{\relaxMirrorBBCodeURLDeveloper}{git@bitbucket.org:nmr-relax/relax.git}
\newcommand{\relaxMirrorBBRegisterURL}{https://bitbucket.org/account/signup/}
\newcommand{\relaxMirrorBBWebInterfaceURL}{https://bitbucket.org/nmr-relax/}
\newcommand{\relaxMirrorGHCodeWebInterfaceURL}{https://github.com/nmr-relax/relax}
\newcommand{\relaxMirrorGHCodeURLDeveloper}{git@github.com:nmr-relax/relax.git}
\newcommand{\relaxMirrorGHRegisterURL}{https://github.com/join}
\newcommand{\relaxMirrorGHWebInterfaceURL}{https://github.com/nmr-relax}
\newcommand{\relaxMirrorGLCodeWebInterfaceURL}{https://gitlab.com/nmr-relax/relax}
\newcommand{\relaxMirrorGLCodeURLDeveloper}{git@gitlab.com:nmr-relax/relax.git}
\newcommand{\relaxMirrorGLRegisterURL}{https://gitlab.com/users/sign_in\#register-pane}
\newcommand{\relaxMirrorGLWebInterfaceURL}{https://gitlab.com/nmr-relax}
\newcommand{\relaxMirrorSFCodeWebInterfaceURL}{https://sourceforge.net/p/nmr-relax/code/ci/master/tree/}
\newcommand{\relaxMirrorSFCodeURLDeveloper}{ssh://[username]@git.code.sf.net/p/nmr-relax/codet}
\newcommand{\relaxMirrorSFRegisterURL}{https://sourceforge.net/user/registration}
\newcommand{\relaxMirrorSFWebInterfaceURL}{https://sourceforge.net/projects/nmr-relax/}
\newcommand{\relaxAnnounceML}{nmr-relax-announce at lists.sourceforge.net}
\newcommand{\relaxAnnounceMLArchiveURL}{https://sourceforge.net/p/nmr-relax/mailman/nmr-relax-announce}
\newcommand{\relaxAnnounceMLSearchURL}{https://sourceforge.net/p/nmr-relax/mailman/search/?mail\_list=nmr-relax-announce}
\newcommand{\relaxAnnounceMLSubscribeURL}{https://sourceforge.net/projects/nmr-relax/lists/nmr-relax-announce}
\newcommand{\relaxCommitsML}{nmr-relax-commits at lists.sourceforge.net}
\newcommand{\relaxCommitsMLArchiveURL}{https://sourceforge.net/p/nmr-relax/mailman/nmr-relax-commits}
\newcommand{\relaxCommitsMLSearchURL}{https://sourceforge.net/p/nmr-relax/mailman/search/?mail\_list=nmr-relax-commits}
\newcommand{\relaxCommitsMLSubscribeURL}{https://sourceforge.net/projects/nmr-relax/lists/nmr-relax-commits}
\newcommand{\relaxDevelML}{nmr-relax-devel at lists.sourceforge.net}
\newcommand{\relaxDevelMLArchiveURL}{https://sourceforge.net/p/nmr-relax/mailman/nmr-relax-devel}
\newcommand{\relaxDevelMLSearchURL}{https://sourceforge.net/p/nmr-relax/mailman/search/?mail\_list=nmr-relax-devel}
\newcommand{\relaxDevelMLSubscribeURL}{https://sourceforge.net/projects/nmr-relax/lists/nmr-relax-devel}
\newcommand{\relaxUsersML}{nmr-relax-users at lists.sourceforge.net}
\newcommand{\relaxUsersMLArchiveURL}{https://sourceforge.net/p/nmr-relax/mailman/nmr-relax-users}
\newcommand{\relaxUsersMLSearchURL}{https://sourceforge.net/p/nmr-relax/mailman/search/?mail\_list=nmr-relax-users}
\newcommand{\relaxUsersMLSubscribeURL}{https://sourceforge.net/projects/nmr-relax/lists/nmr-relax-users}
\newcommand{\relaxBugTrackerURL}{https://sourceforge.net/p/nmr-relax/tickets/}
\newcommand{\relaxBugTrackerSubmitURL}{https://sourceforge.net/p/nmr-relax/tickets/new/}
\newcommand{\relaxBugTrackerSearchURL}{https://sourceforge.net/p/nmr-relax/tickets/search/}
\newcommand{\relaxSRTrackerURL}{https://sourceforge.net/p/nmr-relax/tickets-support/}
\newcommand{\relaxSRTrackerSubmitURL}{https://sourceforge.net/p/nmr-relax/tickets-support/new/}
\newcommand{\relaxSRTrackerSearchURL}{https://sourceforge.net/p/nmr-relax/tickets-support/search/}
\newcommand{\relaxTaskTrackerURL}{https://sourceforge.net/p/nmr-relax/tickets-tasks/}
\newcommand{\relaxTaskTrackerSubmitURL}{https://sourceforge.net/p/nmr-relax/tickets-tasks/new/}
\newcommand{\relaxTaskTrackerSearchURL}{https://sourceforge.net/p/nmr-relax/tickets-tasks/search/}
\newcommand{\relaxCodeURL}{git://git.code.sf.net/p/nmr-relax/code}
\newcommand{\relaxCodeURLDeveloper}{ssh://[username]@git.code.sf.net/p/nmr-relax/code}
\newcommand{\relaxCodeWebInterfaceURL}{https://sourceforge.net/p/nmr-relax/code/ci/master/tree/}
\newcommand{\relaxDemoWebInterfaceURL}{https://sourceforge.net/p/nmr-relax/relax-demo/ci/master/tree/}
\newcommand{\relaxSVNArchiveWebInterfaceURL}{https://sourceforge.net/p/nmr-relax/code-svn-archive/HEAD/tree/}
\newcommand{\relaxWebsiteWebInterfaceURL}{https://sourceforge.net/p/nmr-relax/website/ci/master/tree/}
\newcommand{\relaxDistributionURL}{https://sourceforge.net/projects/nmr-relax/files/}
