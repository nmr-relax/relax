...
For Levenberg-Marquardt\index{minimisation techniques!Levenberg-Marquardt} minisation, the function \quotecmd{lmin} will be called, while for Newton\index{minimisation techniques!Newton} -Raphson, the function \quotecmd{min} will be executed.
...
Function for initialising the diffusion tensor.\index{diffusion!tensor}
...
\keyword{dx\_exe:}  The OpenDX\index{computer programs!OpenDX} executable file. 
...
\subsubsection{Diffusion tensor\index{diffusion!tensor|textbf} parameter string matching patterns}
...
\keyword{grace\_exe:}  The Grace\index{computer programs!Grace}\index{computer programs!Grace} executable file. 
...
\subsubsection{Diffusion tensor\index{diffusion!tensor|textbf} set details}

If the diffusion tensor\index{diffusion!tensor} has not been setup, use the more powerful function \quotecmd{diffusion\_tensor.init} to initialise the tensor parameters.


The diffusion tensor\index{diffusion!tensor} parameters can only be set when the run corresponds to model-free analysis.  The units of the parameters are:
...
\subsubsection{Diffusion tensor\index{diffusion!tensor|textbf} parameter default values}
