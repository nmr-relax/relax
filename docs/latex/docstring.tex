 ...
 \keyword{ command:}  The Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} command to execute.  
 ...
 This user function allows you to pass Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} commands to the program.  This can be useful for automation or scripting.\index{scripting!script file}\index{scripting} 
  

  
 \subsubsection{Example} 

 To reinitialise the Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} instance for the run \quotecmd{aic}, type: 
  

 \example{relax> molmol.command("aic", "InitAll yes")} 
 ...
 \subsection{molmol.ribbon\index{computer programs!Molmol|textbf}} 

  
 \subsubsection{Synopsis} 

 Apply the Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} ribbon style. 
 ...
 This function applies the Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} ribbon style which is equivalent to clicking on \quotecmd{ribbon} in the Molmol\index{computer programs!Molmol}\index{computer programs!Molmol} side menu.  To do this, the following commands are executed: 
  

 \begin{itemize} 
 \item[] CalcAtom \quotecmd{H}  
 \item[] CalcAtom \quotecmd{HN}  
 \item[] CalcSecondary  
 ...
 To apply the ribbon style to the PDB\index{PDB} file loaded for the run \quotecmd{final}, type: 
  

 \example{relax> molmol.ribbon("final")} 

  

 \newpage 

 \subsection{molmol.tensor\_pdb\index{computer programs!Molmol|textbf}} 

  
 \subsubsection{Synopsis} 

 Function displaying\index{display} the diffusion\index{diffusion!tensor} tensor PDB\index{PDB} geometric object over the loaded PDB.\index{PDB} 
 ...
 \keyword{ file:}  The name of the PDB\index{PDB} file containing the tensor geometric object.  
 ...
 In executing this user function, a PDB\index{PDB} file must have previously been loaded into this run, a geometric object or polygon representing the Brownian\index{diffusion!Brownian} rotational\index{rotation} diffusion\index{diffusion!tensor} tensor will be overlain with the loaded PDB\index{PDB} file and displayed\index{display} within Molmol.\index{computer programs!Molmol}\index{computer programs!Molmol}  The PDB\index{PDB} file containing the geometric object must be created using the complementary \quotecmd{pdb.create\_diff\_tensor\_pdb()} user function. 
  

 To display\index{display} the diffusion\index{diffusion!tensor} tensor, the multiple commands will be executed.  To overlay the structure with the diffusion\index{diffusion!tensor} tensor, everything will be selected and reoriented and moved to their original PDB\index{PDB} frame positions: 
 ...
 Next the tensor PDB\index{PDB} file is read\index{read} in, selected, and the covalent bonds of the PDB\index{PDB} CONECT records calculated: 
  

 \begin{itemize} 
 \item[] ReadPdb\index{read} file  
 \item[] SelectMol \quotecmd{@file}  
 \item[] CalcBond 1 1 1  
 \item[]  
 \end{itemize} 
  

 Then only the atoms and bonds of the geometric object are selected and the \quotecmd{ball/stick} style applied: 
  

 \begin{itemize} 
 \item[] SelectAtom \quotecmd{0}  
 \item[] SelectBond \quotecmd{0}  
 \item[] SelectAtom \quotecmd{:TNS}  
 \item[] SelectBond \quotecmd{:TNS}  
 ...
 \begin{itemize} 
 \item[] RadiusAtom 1  
 \item[] SelectAtom \quotecmd{:TNS@C*}  
 \item[] RadiusAtom 1.5  
 \item[]  
 \end{itemize} 
 ...
 \begin{itemize} 
 \item[] cmd.hide(\quotecmd{everything}, file)  
 \item[] cmd.show(\quotecmd{cartoon}, file)  
 \item[] util.cbss(file, \quotecmd{red}, \quotecmd{yellow}, \quotecmd{green})  
 \item[]  
 \end{itemize} 
  

 where file is the file name without the \quotecmd{.pdb} extension. 
  

  
 \subsubsection{Example} 

 To apply this user function to the run \quotecmd{final}, type: 
  

 \example{relax> pymol.cartoon("final")} 
 ...
 \keyword{ command:}  The PyMOL command to execute.  
 ...
 This user function allows you to pass PyMOL commands to the program.  This can be useful for automation or scripting.\index{scripting!script file}\index{scripting} 
  

  
 \subsubsection{Example} 

 To reinitialise the PyMOL instance for the run \quotecmd{aic}, type: 
  

 \example{relax> pymol.command("aic", "reinitialise")} 
 ...
 This function allows residues specific values to be mapped\index{map} to a structure through PyMOL macros.  Currently only the \quotecmd{classic} style, which is described below, is available. 
 ...
 \example{relax> pymol.macro\_exec(`final', `S2')} 

 \example{relax> pymol.macro\_exec(`final', data\_type=`S2')} 

 \example{relax> pymol.macro\_exec(`final', data\_type=`S2', style="classic")} 
 ...
 In executing this user function, a PDB\index{PDB} file must have previously been loaded into this run, a geometric object or polygon representing the Brownian\index{diffusion!Brownian} rotational\index{rotation} diffusion\index{diffusion!tensor} tensor will be overlain with the loaded PDB\index{PDB} file and displayed\index{display} within PyMOL.  The PDB\index{PDB} file containing the geometric object must be created using the complementary \quotecmd{pdb.create\_diff\_tensor\_pdb()} user function. 
  

 The tensor PDB\index{PDB} file is read\index{read} in using the command: 
 ...
 The centre of mass residue \quotecmd{COM} is displayed\index{display} using the commands: 
  

 \begin{itemize} 
 \item[] select resn COM  
 \item[] show dots, \quotecmd{sele}  
 \item[] color blue, \quotecmd{sele}  
 \item[]  
 \end{itemize} 
  

 The axes of the diffusion\index{diffusion!tensor} tensor, the residue \quotecmd{AXS}, is displayed\index{display} using the commands: 
  

 \begin{itemize} 
 \item[] select resn AXS  
 \item[] hide (\quotecmd{sele})  
 \item[] show sticks, \quotecmd{sele}  
 \item[] color cyan, \quotecmd{sele}  
 \item[] label \quotecmd{sele}, name  
 \item[]  
 \end{itemize} 
  

 The simulation axes, the residues \quotecmd{SIM}, are displayed\index{display} using the commands: 
  

 \begin{itemize} 
 \item[] select resn SIM  
 \item[] colour cyan, \quotecmd{sele}  
 \item[]  
 \end{itemize} 
 ...
 Function displaying\index{display} the PDB\index{PDB} file representation of the XH vector distribution. 
 ...
 \keyword{ file:}  The name of the PDB\index{PDB} file containing the vector distribution.  
 ...
 A PDB\index{PDB} file of the macromolecule must have previously been loaded as the vector distribution will be overlain with the macromolecule within PyMOL.  The PDB\index{PDB} file containing the vector distribution must be created using the complementary \quotecmd{pdb.create\_vector\_dist()} user function. 
  

 The vector distribution PDB\index{PDB} file is read\index{read} in using the command: 
 ...
 \example{relax> pymol.view(`m1')} 

 \example{relax> pymol.view(run=`pdb')} 
 ...
 This function allows residues specific values to be mapped\index{map} to a structure through the creation of a PyMOL macro which can be executed in PyMOL by clicking on \quotecmd{File, Macro, Execute User...}.  Currently only the \quotecmd{classic} style, which is described below, is available. 
 ...
 To create a PyMOL macro mapping\index{map} the order\index{order parameter} parameter values, $S^2$, of the run \quotecmd{final} onto the structure using the classic style, type: 
  

 \example{relax> pymol.write(`final', `S2')} 

 \example{relax> pymol.write(`final', data\_type=`S2')} 

 \example{relax> pymol.write(`final', data\_type=`S2', style="classic", file=`s2.mac', dir=`pymol')} 
 ...
 \keyword{ boolean:}  The boolean operator specifying how residues should be selected.   

 \keyword{ change\_all:}  A flag specifying if all other residues should be changed.   

 \keyword{ column:}  The column containing the residue numbers (defaulting to 0, the first column).  
 ...
 To select the residues in the second column of the relaxation\index{relaxation} data file \quotecmd{r1.600} while deselecting all other residues, type one of:  
  

 \example{relax> select.read(`test', `r1.600', change\_all=1, column=1)} 

 \example{relax> select.read(run=`test', file=`r1.600', change\_all=1, column=1)} 

  
 \subsubsection{Boolean operators} 

 The \quotecmd{boolean} keyword argument can be used to change how spin systems are selected.  The allowed values are: \quotecmd{OR}, \quotecmd{NOR}, \quotecmd{AND}, \quotecmd{NAND}, \quotecmd{XOR}, \quotecmd{XNOR}.  The following table details how the selections will occur for the different boolean operators. 
 ...
 Create a PDB\index{PDB} file to represent the diffusion\index{diffusion!tensor} tensor. 
 ...
 \keyword{ scale:}  Value for scaling the diffusion rates.   

 \keyword{ file:}  The name of the PDB\index{PDB} file.   

 \keyword{ dir:}  The directory where the file is located.   

 \keyword{ force:}  A flag which, if set to 1, will overwrite the any pre-existing file.  
 ...
 This function creates a PDB\index{PDB} file containing an artificial geometric structure to represent the diffusion\index{diffusion!tensor} tensor.  A structure must have previously been read\index{read} into relax.  The diffusion\index{diffusion!tensor} tensor is represented by an ellipsoidal,\index{diffusion!ellipsoid (asymmetric)} spheroidal,\index{diffusion!spheroid (axially symmetric)} or spherical geometric object with its origin located at the centre of mass (of the selected residues).  This diffusion\index{diffusion!tensor} tensor PDB\index{PDB} file can subsequently read\index{read} into any molecular viewer. 
  

 There are four different types of residue within the PDB.\index{PDB}  The centre of mass of the selected residues is represented as a single carbon atom of the residue \quotecmd{COM}.  The ellipsoidal\index{diffusion!ellipsoid (asymmetric)} geometric shape consists of numerous H atoms of the residue \quotecmd{TNS}.  The axes of the tensor, when defined, are presented as the residue \quotecmd{AXS} and consist of carbon atoms: one at the centre of mass and one at the end of each eigenvector.  Finally, if Monte Carlo simulations were run and the diffusion\index{diffusion!tensor} tensor parameters were allowed to vary then there will be multiple \quotecmd{SIM} residues, one for each simulation.  These are essentially the same as the \quotecmd{AXS} residue, representing the axes of the simulated tensors, and they will appear as a distribution. 
  

 As the Brownian\index{diffusion!Brownian} rotational\index{rotation} diffusion\index{diffusion!tensor} tensor is a measure of the rate of rotation\index{rotation} about different axes - the larger the geometric object, the faster the diffusion of a molecule.\index{molecule} For example the diffusion\index{diffusion!tensor} tensor of a water molecule\index{molecule} is much larger than that of a macromolecule. 
  

 The effective global correlation\index{correlation time} time experienced by an XH bond vector, not to be confused with the Lipari and Szabo parameter $\tau$\_e, will be approximately proportional to the component of the diffusion\index{diffusion!tensor} tensor parallel to it.  The approximation is not exact due to the multiexponential form of the correlation function of Brownian\index{diffusion!Brownian} rotational\index{rotation} diffusion.  If an XH bond vector is parallel to the longest axis of the tensor, it will be unaffected by rotations\index{rotation} about that axis, which are the fastest rotations\index{rotation} of the molecule,\index{molecule} and therefore its effective global correlation\index{correlation time} time will be maximal. 
  

 To set the size of the diffusion\index{diffusion!tensor} tensor within the PDB\index{PDB} frame the unit vectors used to generate the geometric object are first multiplied by the diffusion\index{diffusion!tensor} tensor (which has the units of inverse seconds) then by the scaling factor (which has the units of second \AA and has the default value of 1.8e-6 s.Angstrom).  Therefore the rotational\index{rotation} diffusion rate per \AA is equal the inverse of the scale value (which defaults to 5.56e5 s\^{}-1.Angstrom\^{}-1).  Using the default scaling value for spherical diffusion, the correspondence between global correlation\index{correlation time} time, $\Diff_{iso}$ diffusion rate, and the radius of the sphere\index{diffusion!sphere (isotropic)} for a number of discrete cases will be: 
 ...
 The scaling value has been fixed to facilitate comparisons within or between publications, but can be changed to vary the size of the tensor geometric object if necessary.  Reporting the rotational\index{rotation} diffusion rate per \AA within figure legends would be useful. 
  

 To create the tensor PDB\index{PDB} representation, a number of algorithms are utilised.  Firstly the centre of mass is calculated for the selected residues and is represented in the PDB\index{PDB} by a C atom.  Then the axes of the diffusion are calculated, as unit vectors scaled to the appropriate length (multiplied by the eigenvalue\index{eigenvalues} $\Diff_x$, $\Diff_y$, $\Diff_z$, $\Diff_\Par$, $\Diff_\Per$, or $\Diff_{iso}$ as well as the scale value), and a C atom placed at the position of this vector plus the centre of mass.  Finally a uniform distribution of vectors on a sphere\index{diffusion!sphere (isotropic)} is generated using spherical coordinates.  By incrementing the polar angle\index{angles} using an arccos distribution, a radial array of vectors representing latitude are created while incrementing the azimuthal angle\index{angles} evenly creates the longitudinal vectors.  These unit vectors, which are distributed within the PDB\index{PDB} frame and are of 1 \AA in length, are first rotated into the diffusion frame using a rotation\index{rotation} matrix (the spherical diffusion\index{diffusion!tensor} tensor is not rotated).  Then they are multiplied by the diffusion\index{diffusion!tensor} tensor matrix to extend the vector out to the correct length, and finally multiplied by the scale value so that the vectors reasonably superimpose onto the macromolecular structure.  The last set of algorithms place all this information into a PDB\index{PDB} file.  The distribution of vectors are represented by H atoms and are all connected using PDB\index{PDB} CONECT records.  Each H atom is connected to its two neighbours on the both the longitude and latitude.  This creates a geometric PDB\index{PDB} object with longitudinal and latitudinal lines. 
 ...
 Create a PDB\index{PDB} file representation of the distribution of XH bond vectors. 
  

  
 \subsubsection{Defaults} 

 \textsf{\textbf{structure.create\_vector\_dist}(self, run=None, length=2.0000000000000001e-09, symmetry=1, file=`XH\_dist.pdb', dir=None, force=0)} 
 ...
 \keyword{ length:}  The length of the vectors in the PDB\index{PDB} representation (meters).   

 \keyword{ symmetry:}  A flag which, if set to 1, will create a second chain with reversed XH bond     orientations.   

 \keyword{ file:}  The name of the PDB\index{PDB} file.   

 \keyword{ dir:}  The directory to place the file into.   

 \keyword{ force:}  A flag which, if set to 1, will overwrite the file if it already exists.  
 ...
 This function creates a PDB\index{PDB} file containing an artificial vectors, the length of which default to the length argument of 20 \AA.  A structure must have previously been read\index{read} into relax.  The origin of the vector distribution is located at the centre of mass (of the selected residues).  This vector distribution PDB\index{PDB} file can subsequently be read\index{read} into any molecular viewer. 
  

 Because of the symmetry of the diffusion\index{diffusion!tensor} tensor reversing the orientation of the XH bond vector has no effect.  Therefore by setting the symmetry flag two chains \quotecmd{A} and \quotecmd{B} will be added to the PDB\index{PDB} file whereby chain \quotecmd{B} is chain \quotecmd{A} with the XH bonds reversed. 
 ...
 \example{relax> structure.read\_pdb(`m8', `test.pdb', `\~{}/pdb', 1)} 

 \example{relax> structure.read\_pdb(run=`m8', file=`test.pdb', dir=`pdb', model=1)} 

 To load the 10$^\mathrm{th}$ model from the file \quotecmd{test.pdb}, use: 
  

 \example{relax> structure.read\_pdb(`m1', `test.pdb', model=10)} 

 \example{relax> structure.read\_pdb(run=`m1', file=`test.pdb', model=10)} 
 ...
 \example{relax> structure.vectors(`test')} 

 \example{relax> structure.vectors(`test', `N')} 

 \example{relax> structure.vectors(`test', `N', `H')} 

 \example{relax> structure.vectors(`test', heteronuc=`N', proton=`H')} 

 If the attached proton is called \quotecmd{HN}, type: 
  

 \example{relax> structure.vectors(`test', proton=`HN')} 
 ...
 \example{relax> structure.vectors(`m1', `N1', `H1', res\_name=`G')} 

 \example{relax> structure.vectors(`m1', `N3', `H3', res\_name=`U')} 
 ...
 To unselect the residues in the second column of the relaxation\index{relaxation} data file \quotecmd{r1.600} while selecting all other residues, type one of:  
  

 \example{relax> unselect.read(`test', `r1.600', change\_all=1, column=1)} 

 \example{relax> unselect.read(run=`test', file=`r1.600', change\_all=1, column=1)} 
