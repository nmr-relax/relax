...
\begin{itemize}
\item[]     [] - A sequence or set of characters to match to a single character.  For example, 
\quoteenv{`[Nn]ewton'}
 will match both 
\quoteenv{`Newton'}
 and 
\quoteenv{`newton'}
. 
\item[]     \^{} - Match the start of the string. 
\item[]     \$ - Match the end of the string.  For example, 
\quoteenv{`\^{}[Ll][Mm]\$'}
 will match 
\quoteenv{`lm'}
 and 
