 ...
 \textsf{\textbf{molmol.write}(self, run=None, data\_type=None, style=`classic', colour\_start=None, colour\_end=None, file=None, dir=`molmol', force=0)} 
 ...
 \keyword{ colour\_start:}  The starting colour of the linear colour gradient.   

 \keyword{ colour\_end:}  The ending colour of the linear colour gradient.   
 ...
 Description:  The classic style draws the backbone of the protein in \quotecmd{neon} style.  Rather than colouring the amino acids to which the NH bond belongs, the three covalent bonds of the petide bond from Ca to Ca to which the NH bond belongs are coloured.  Deselected residues are shown as black lines. 
 ...
 \subsubsection{RGB colour arrays} 
