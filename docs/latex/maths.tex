...
The chi-squared equation is itself dependent on the relaxation equations throught the back calculated relaxation data R$(\theta)$.  These data are the spin-latice \index{relaxation rate!spin-latice} , spin-spin \index{relaxation rate!spin-spin}, and cross-relaxation rates of \citet{Abragam61} and are respectively
\begin{align}
