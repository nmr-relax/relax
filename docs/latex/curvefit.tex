...
All delays in the pulse sequence should be carefully checked to be sure that the time is exactly what you would expect.  To set the time and close the wizard, click on the \guibutton{Finish} button.
