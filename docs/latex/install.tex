...
If, for older dependency versions, errors do occur please submit a \href{\relaxBugTrackerURL}{bug report to the bug tracker}\index{bug!tracker}.
...
Otherwise please submit a \href{\relaxBugTrackerSubmitURL}{bug report to the bug tracker}\index{bug!tracker}.
