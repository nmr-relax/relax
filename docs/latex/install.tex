%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                             %
% Copyright (C) 2003-2004,2006,2012-2014 Edward d'Auvergne                    %
%                                                                             %
...
\begin{description}
  ...
  \item[\href{http://wxpython.org/}{wxPython}\index{wxPython}:]  Version 2.9 or higher.
...
If, for older dependency versions, errors do occur please submit a bug report to the bug tracker\index{bug!tracker} at \href{https://web.archive.org/web/https://gna.org/bugs/?group=relax}{https://web.archive.org/web/https://gna.org/bugs/?group=relax}.
...
Otherwise please submit a bug report to the bug tracker\index{bug!tracker} at \href{https://web.archive.org/web/https://gna.org/bugs/?group=relax}{https://web.archive.org/web/https://gna.org/bugs/?group=relax}.
