...
For finding the average domain position in the rigid frame order model\index{frame order!model!rigid}, an alternating grid search has been implemented in the automated analysis protocol.
