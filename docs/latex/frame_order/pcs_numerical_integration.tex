...
This is implemented in the relax \uf{frame\ufus{}order\ufsep{}sobol\ufus{}setup} user function.
...
This is implemented in the software \href{http://www.nmr-relax.com}{relax} rather than in the \href{https://gna.org/projects/minfx/}{minfx optimisation library}\index{optimisation!minfx}.
