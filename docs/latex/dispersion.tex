...
The following is a list of the officially released software which you can use instead of or in combination with relax:
...
There is currently support in relax for generating the input files for CPMGFit, CATIA, NESSY, and ShereKhan and for running some of this software from within relax.

The features of the different software are compared in Table~\ref{table: dispersion software}.
