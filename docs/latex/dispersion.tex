...
This is the model for 2-site exchange on all times scales (with the constraint that $\pA \gg \pB$), named after Ishima and Torchia 1999.  It is selected by setting the model to `IT99'.  The equation is:
\begin{align}
