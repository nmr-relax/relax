...
\item ZZ exchange.
\item HD exchange.
\item Support for ZQ (zero quantum) and DQ (double quantum) CPMG and $\Ronerho$ dispersion data.
\end{itemize}
...
\item[`MMQ 3-site':]\index{relaxation dispersion!MMQ 3-site model}  The model of the numeric solution for 3-site exchange for multiple quantum CPMG-type data.
