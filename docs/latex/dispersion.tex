...
\item[`MP05':]\index{relaxation dispersion!TP04 model}  The $\Ronerho$-type data \citet{MiloushevPalmer05} 2-site analytic equation for all time scales with parameters $\{\Ronerhoprime, \dots, \pA, \dw, \kex\}$.
