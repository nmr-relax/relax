...
def fletcher_reeves(func, dfunc=None, args=(), x0=None, min_options=None, func_tol=1e-5, maxiter=1000, full_output=0, print_flag=0, a0=1.0, mu=0.0001, eta=0.1):
	...
	min = Fletcher_reeves(func, dfunc, args, x0, min_options, func_tol, maxiter, full_output, print_flag, a0, mu, eta)
	if min.init_failure:
...
class Fletcher_reeves(generic_conjugate_gradient, generic_minimise, line_search_functions):
