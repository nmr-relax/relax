...
class test:
	def __init__(self, mf):
		...
		types = [ ['NOE', '600', 600.0], ['R1', '600', 600.0], ['R2', '600', 600.0], ['NOE', '500', 500.0], ['R1', '500', 500.0], ['R2', '500', 500.0] ]
		...
		# S2 = 0.9, te = 0, Rex = 10
		values = [0.82343423455568532, 1.2140646900196883, 22.970321955068375, 0.80450535030695758, 1.5783476768339382, 19.186850317928108]
		errors = [0.04, 0.024281293800393768, 0.45940643910136753, 0.05, 0.031566953536678766, 0.38373700635856217]
		...
		if match('m1', function_ops[2]):
			...
			grid_ops.append([20.0, 0.0, 1.0])
			grid_ops.append([20.0, 0.0, 30.0 / 600000000.0**2])
