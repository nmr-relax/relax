...
class Relax_disp_params(Param_list):
    ...
    def __init__(self):
        ...
        self._add('theta', scope='spin', desc='Rotating frame tilt angle : ( theta = arctan(Omega / w_1) ) (rad)', grace_string='Rotating frame tilt angle (rad)', py_type=dict, set='all', err=False, sim=False)
