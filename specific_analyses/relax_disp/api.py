...
from specific_analyses.relax_disp.variables import CPMG_EXP, FIXED_TIME_EXP, MODEL_LIST_FULL, MODEL_LM63, MODEL_CR72, MODEL_CR72_RED, MODEL_DPL94, MODEL_IT99, MODEL_M61, MODEL_M61B, MODEL_NOREX, MODEL_NS_2SITE_3D, MODEL_NS_2SITE_3D_RED, MODEL_NS_2SITE_STAR, MODEL_NS_2SITE_STAR_RED, MODEL_R2EFF, R1RHO_EXP, VAR_TIME_EXP
...
class Relax_disp(API_base, API_common):
    ...
    def _back_calc_r2eff(self, spin=None, spin_id=None):
        ...
        model = Dispersion(model=spin.model, num_params=param_num(spins=[spin]), num_spins=1, num_frq=field_count, num_disp_points=cdp.dispersion_points, values=values, errors=errors, missing=missing, frqs=frqs, cpmg_frqs=return_cpmg_frqs(ref_flag=False), spin_lock_nu1=return_spin_lock_nu1(ref_flag=False), relax_time=cdp.relax_time_list[0], scaling_matrix=scaling_matrix)
    ...
    def _select_model(self, model=MODEL_R2EFF):
        ...
        @keyword model: The relaxation dispersion analysis type.  This can be one of 'R2eff', 'No Rex', 'LM63', 'CR72', 'CR72 red', 'IT99', 'M61', 'DPL94', 'M61 skew', 'NS 2-site star', 'NS 2-site star red'.
        @type model:    str
        """
        ...
        # CR72 red model.
        elif model == MODEL_CR72_RED:
            print("The Carver and Richards (1972) 2-site model for all time scales, whereby the simplification R20A = R20B is assumed.")
            params = []
            for frq in loop_frq():
                params.append('r2')
            params += ['pA', 'dw', 'kex']
        ...
        # NS 2-site 3D model.
            ...
            print("The numerical solution for the 2-site Bloch-McConnell equations using 3D magnetisation vectors.")
            params = []
            for frq in loop_frq():
                params.append('r2a')
            for frq in loop_frq():
        ...
        # NS 2-site 3D red model.
            ...
            print("The numerical solution for the 2-site Bloch-McConnell equations using 3D magnetisation vectors, whereby the simplification R20A = R20B is assumed.")
            params = []
            for frq in loop_frq():
                params.append('r2')
            params += ['pA', 'dw', 'kex']
        ...
        # NS 2-site star model.
            ...
            print("The numerical solution for the 2-site Bloch-McConnell equations using complex conjugate matrices.")
            params = []
            for frq in loop_frq():
                params.append('r2a')
            for frq in loop_frq():
        ...
        # NS 2-site star red model.
            ...
            print("The numerical solution for the 2-site Bloch-McConnell equations using complex conjugate matrices, whereby the simplification R20A = R20B is assumed.")
            params = []
            for frq in loop_frq():
                params.append('r2')
            params += ['pA', 'dw', 'kex']
