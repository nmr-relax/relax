...
from specific_analyses.relax_disp.variables import CPMG_EXP, FIXED_TIME_EXP, MODEL_LIST_FULL, MODEL_LM63, MODEL_CR72, MODEL_DPL94, MODEL_IT99, MODEL_M61, MODEL_M61B, MODEL_NOREX, MODEL_NS_2SITE_STAR, MODEL_R2EFF, R1RHO_EXP, VAR_TIME_EXP
...
class Relax_disp(API_base, API_common):
    ...
    def _select_model(self, model=MODEL_R2EFF):
        ...
        @keyword model: The relaxation dispersion analysis type.  This can be one of 'R2eff', 'No Rex', 'LM63', 'CR72', 'IT99', 'M61', 'DPL94', 'M61 skew', 'NS 2-site star'.
        @type model:    str
        """
