...
class Relax_disp(API_base, API_common):
    ...
    def __init__(self):
        ...
        self.PARAMS.add('theta', scope='spin', desc='Rotating frame tilt angle : ( theta = arctan(w_1 / Omega )', set='params', py_type=dict, grace_string='\\q\\xtheta\\N\\Q)', err=True, sim=True)
