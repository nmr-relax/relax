...
class Relax_disp(API_base, API_common):
    ...
    def __init__(self):
        ...
        self.PARAMS.add('theta', scope='spin', desc='Rotating frame tilt angle : ( theta = arctan(w_1 / Omega) )', set='params', py_type=dict, err=False, sim=False)
        self.PARAMS.add('w_eff', scope='spin', desc='Effective field in rotating frame : ( w_eff = sqrt(Omega^2 + w_1^2) )', set='params', py_type=dict, err=False, sim=False)
