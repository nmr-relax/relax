...
table = uf_tables.add_table(label="table: dispersion default values", caption="Relaxation dispersion default values.")
table.add_headings(["Data type", "Object name", "Value"])
table.add_row(["Transversal relaxation rate (rad/s)", "'r2'", "15.0"])
table.add_row(["Transversal relaxation rate for state A (rad/s)", "'r2a'", "15.0"])
table.add_row(["Transversal relaxation rate for state B (rad/s)", "'r2b'", "15.0"])
table.add_row(["Population of state A", "'pA'", "0.5"])
table.add_row(["Population of state B", "'pB'", "0.5"])
table.add_row(["Population of state C", "'pC'", "0.5"])
table.add_row(["The pA.pB.dw**2 parameter (ppm^2)", "'phi_ex'", "5.0"])
table.add_row(["The pA.pB.dw**2 parameter of state B (ppm^2)", "'phi_ex_B'", "5.0"])
table.add_row(["The pA.pB.dw**2 parameter of state C (ppm^2)", "'phi_ex_C'", "5.0"])
table.add_row(["The pA.dw**2 parameter (ppm^2)", "'padw2'", "1.0"])
table.add_row(["Chemical shift difference between states A and B (ppm)", "'dw'", "0.0"])
table.add_row(["Chemical shift difference between states A and B for 3-site exchange (ppm)", "'dw_AB'", "0.0"])
table.add_row(["Chemical shift difference between states A and C for 3-site exchange (ppm)", "'dw_AC'", "0.0"])
table.add_row(["Chemical shift difference between states B and C for 3-site exchange (ppm)", "'dw_BC'", "0.0"])
table.add_row(["Proton chemical shift difference between states A and B (ppm)", "'dwH'", "0.0"])
table.add_row(["Proton chemical shift difference between states A and B for 3-site exchange (ppm)", "'dwH_AB'", "0.0"])
table.add_row(["Proton chemical shift difference between states A and C for 3-site exchange (ppm)", "'dwH_AC'", "0.0"])
table.add_row(["Proton chemical shift difference between states B and C for 3-site exchange (ppm)", "'dwH_BC'", "0.0"])
table.add_row(["Exchange rate (rad/s)", "'kex'", "10000.0"])
table.add_row(["Exchange rate between sites A and B for 3-site exchange (rad/s)", "'kex_AB'", "10000.0"])
table.add_row(["Exchange rate between sites A and C for 3-site exchange (rad/s)", "'kex_AC'", "10000.0"])
table.add_row(["Exchange rate between sites B and C for 3-site exchange (rad/s)", "'kex_BC'", "10000.0"])
table.add_row(["Exchange rate between sites A and B (rad/s)", "'kB'", "10000.0"])
table.add_row(["Exchange rate between sites A and C (rad/s)", "'kC'", "10000.0"])
table.add_row(["Time of exchange (s/rad)", "'tex'", "1.0/10000.0"])
table.add_row(["Rotating frame tilt angle", "'theta'", "0.0"])
table.add_row(["Effective field in rotating frame", "'w_eff'", "0.0"])
table.add_row(["Exchange rate from state A to state B (rad/s)", "'k_AB'", "10000.0"])
table.add_row(["Exchange rate from state B to state A (rad/s)", "'k_BA'", "10000.0"])
...
table = uf_tables.add_table(label="table: dispersion curve-fit data type patterns", caption="Relaxation dispersion curve fitting data type string matching patterns.")
table.add_headings(["Data type", "Object name"])
table.add_row(["Transversal relaxation rate (rad/s)", "'r2'"])
table.add_row(["Transversal relaxation rate for state A (rad/s)", "'r2a'"])
table.add_row(["Transversal relaxation rate for state B (rad/s)", "'r2b'"])
table.add_row(["Population of state A", "'pA'"])
table.add_row(["Population of state B", "'pB'"])
table.add_row(["Population of state C", "'pC'"])
table.add_row(["The pA.pB.dw**2 parameter (ppm^2)", "'phi_ex'"])
table.add_row(["The pA.dw**2 parameter (ppm^2)", "'padw2'"])
table.add_row(["Chemical shift difference between states A and B (ppm)", "'dw'"])
table.add_row(["Chemical shift difference between states A and B for 3-site exchange (ppm)", "'dw_AB'"])
table.add_row(["Chemical shift difference between states A and C for 3-site exchange (ppm)", "'dw_AC'"])
table.add_row(["Chemical shift difference between states B and C for 3-site exchange (ppm)", "'dw_BC'"])
table.add_row(["Proton chemical shift difference between states A and B (ppm)", "'dwH'"])
table.add_row(["Proton chemical shift difference between states A and B for 3-site exchange (ppm)", "'dwH_AB'"])
table.add_row(["Proton chemical shift difference between states A and C for 3-site exchange (ppm)", "'dwH_AC'"])
table.add_row(["Proton chemical shift difference between states B and C for 3-site exchange (ppm)", "'dwH_BC'"])
table.add_row(["Exchange rate (rad/s)", "'kex'"])
table.add_row(["Exchange rate between sites A and B for 3-site exchange (rad/s)", "'kex_AB'"])
table.add_row(["Exchange rate between sites A and C for 3-site exchange (rad/s)", "'kex_AC'"])
table.add_row(["Exchange rate between sites B and C for 3-site exchange (rad/s)", "'kex_BC'"])
table.add_row(["Exchange rate from state A to state B (rad/s)", "'k_AB'"])
table.add_row(["Exchange rate from state B to state A (rad/s)", "'k_BA'"])
table.add_row(["Time of exchange (s/rad)", "'tex'"])
table.add_row(["Rotating frame tilt angle", "'theta'"])
table.add_row(["Effective field in rotating frame", "'w_eff'"])
table.add_row(["Peak intensities (series)", "'peak_intensity'"])
table.add_row(["CPMG pulse train frequency (series, Hz)", "'cpmg_frqs'"])
