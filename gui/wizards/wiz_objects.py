    ...
    def _build_buttons(self):
        ...
        for i in range(self._num_pages):
            ...
            if self._button_apply_flag[i]:
                ...
                button.SetFont(font.normal)
                if single_page:
                    button.SetToolTip(wx.ToolTip("Apply the operation and leave the window open."))
                else:
                    button.SetToolTip(wx.ToolTip("Apply the operation and stay on the current page."))
                button.SetMinSize(self._size_button)
                self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
            ...
            if self._button_skip_flag[i]:
                ...
                button.SetFont(font.normal)
                button.SetToolTip(wx.ToolTip("Skip the operation and move to the next page."))
                button.SetMinSize(self._size_button)
                self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
            ...
            if not single_page and i < self._num_pages - 1:
                ...
                button.SetFont(font.normal)
                button.SetToolTip(wx.ToolTip("Apply the operation and move to the next page."))
                button.SetMinSize(self._size_button)
                self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
            ...
            if single_page:
                ...
                button.SetFont(font.normal)
                button.SetToolTip(wx.ToolTip("Apply the operation and close the window."))
                button.SetMinSize(self._size_button)
                self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
            ...
            if not single_page and i == self._num_pages - 1:
                ...
                button.SetFont(font.normal)
                button.SetToolTip(wx.ToolTip("Apply the operation and close the wizard."))
                button.SetMinSize(self._size_button)
                self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
                self.Bind(wx.EVT_BUTTON, self._ok, button)
            ...
            button.SetFont(font.normal)
            if single_page:
                button.SetToolTip(wx.ToolTip("Abort the operation and close the window."))
            else:
                button.SetToolTip(wx.ToolTip("Abort the operation and close the wizard."))
            button.SetMinSize(self._size_button)
            self._button_sizers[i].Add(button, 0, wx.ADJUST_MINSIZE, 0)
