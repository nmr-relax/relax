...
class Disp_model_list(Model_list):
    ...
    model_desc = [
        ...
        "The model for no chemical exchange being present, for off-resonance R1rho-type experiments whereby R1 is fitted.  R1rho = R1 * cos(theta)^2 + r1rho_prime * sin(theta)^2.",
        None,
        ...
        "The Davis, Perlman and London (1994) 2-site fast exchange equation, whereby R1 is fitted.",
        "The Trott and Palmer (2002) 2-site equation for all time scales.",
        "The Trott and Palmer (2002) 2-site equation for all time scales, whereby R1 is fitted.",
        "The Trott, Abergel and Palmer (2003) off-resonance 2-site equation for all time scales.",
        "The Trott, Abergel and Palmer (2003) off-resonance 2-site equation for all time scales, whereby R1 is fitted.",
        "The Miloushev and Palmer (2005) off-resonance 2-site equation for all time scales.",
        "The Miloushev and Palmer (2005) off-resonance 2-site equation for all time scales, whereby R1 is fitted.",
        "The 2-site numerical solution using 3D magnetisation vectors.",
        "The 2-site numerical solution using 3D magnetisation vectors, whereby R1 is fitted.",
        ...
        None,
        "The CR72 2-site model extended to MMQ CPMG data by Korzhnev et al., 2004.",
