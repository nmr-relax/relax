...
class Auto_rx(Base_analysis):
    ...
    def build_right_box(self):
        ...
        self.field_nmr_frq = self.add_text_sel_element(box, self, text="NMR frequency label [MHz]", default=self.data.frq, tooltip="This label is added to the output files.  For example if the label is '600', the %s values will be located in the file '%s.600.out'." % (self.label, lower(self.label)))
