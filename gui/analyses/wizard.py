...
class New_analysis_page(Wiz_page):
    ...
    def add_buttons(self, box):
        ...
        # The R1 button.
        self.button_r1 = self.create_button(id=self.button_ids['r1'], box=sizer1, size=size, bmp=paths.ANALYSIS_IMAGE_PATH+"r1_150x150.png", tooltip=u"R\u2081 relaxation curve-fitting analysis", fn=self.select_r1)

        # The R2 button.
        self.button_r2 = self.create_button(id=self.button_ids['r2'], box=sizer1, size=size, bmp=paths.ANALYSIS_IMAGE_PATH+"r2_150x150.png", tooltip=u"R\u2082 relaxation curve-fitting analysis", fn=self.select_r2)
