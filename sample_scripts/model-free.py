...
set_value(name, 1.02 * 1e-10, 'bond_length')
set_value(name, -160 * 1e-6, 'csa')
...
# Fixed value.
#from math import pi
#set_value(name, [ 0.97, 2.048*1e-9, 0.149 / (2.0 * pi * 600000000.0)**2 ])
#set_value(name, [ 6.00000000e-01, 5.00000000e-01, 1.00000000e-9])
#set_value(name)
#fix(name, 'all_res')
