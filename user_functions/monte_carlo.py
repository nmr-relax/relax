...
uf.desc[-1].add_paragraph("The errors generated per simulation can either be generated indidual per datapoint and drawn from a gauss distrubtion described by the STD of the indidual point, or it can be generated from a overall gauss distribution described by the STD_fit of the goodness of fit, where STD_fit = sqrt(chi2/(N-p)).  The last possibility is to supply a fixed value of STD, from which gauss distribution to draw errors from.")
...
uf.desc.append(monte_carlo_desc)
uf.backend = error_analysis.monte_carlo_error_analysis
...
uf.desc.append(monte_carlo_desc)
uf.backend = error_analysis.monte_carlo_initial_values
...
uf.desc.append(monte_carlo_desc)
uf.backend = error_analysis.monte_carlo_off
uf.menu_text = "o&ff"
...
uf.desc.append(monte_carlo_desc)
uf.backend = error_analysis.monte_carlo_on
uf.menu_text = "o&n"
...
uf.desc.append(monte_carlo_desc)
uf.backend = error_analysis.monte_carlo_setup
uf.menu_text = "&setup"
