...
uf.add_keyarg(
    ...
    wiz_combo_choices = [
        "m0:  {}",
        "m1:  {%s}" % text.s2,
        "m2:  {%s, %s}" % (text.s2, text.te),
        "m3:  {%s, %s}" % (text.s2, text.rex),
        "m4:  {%s, %s, %s}" % (text.s2, text.te, text.rex),
        "m5:  {%s, %s, %s}" % (text.s2, text.s2f, text.ts),
        "m6:  {%s, %s, %s, %s}" % (text.s2, text.tf, text.s2f, text.ts),
        "m7:  {%s, %s, %s, %s}" % (text.s2, text.s2f, text.ts, text.rex),
        "m8:  {%s, %s, %s, %s, %s}" % (text.s2, text.tf, text.s2f, text.ts, text.rex),
        "m9:  {%s}" % text.rex,
        "",
        "tm0:  {%s}" % text.local_tm,
        "tm1:  {%s, %s}" % (text.local_tm, text.s2),
        "tm2:  {%s, %s, %s}" % (text.local_tm, text.s2, text.te),
        "tm3:  {%s, %s, %s}" % (text.local_tm, text.s2, text.rex),
        "tm4:  {%s, %s, %s, %s}" % (text.local_tm, text.s2, text.te, text.rex),
        "tm5:  {%s, %s, %s, %s}" % (text.local_tm, text.s2, text.s2f, text.ts),
        "tm6:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.s2, text.tf, text.s2f, text.ts),
        "tm7:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.s2, text.s2f, text.ts, text.rex),
        "tm8:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "tm9:  {%s, %s}" % (text.local_tm, text.rex),
        "",
        "m10:  {%s}" % text.csa,
        "m11:  {%s, %s}" % (text.csa, text.s2),
        "m12:  {%s, %s, %s}" % (text.csa, text.s2, text.te),
        "m13:  {%s, %s, %s}" % (text.csa, text.s2, text.rex),
        "m14:  {%s, %s, %s, %s}" % (text.csa, text.s2, text.te, text.rex),
        "m15:  {%s, %s, %s, %s}" % (text.csa, text.s2, text.s2f, text.ts),
        "m16:  {%s, %s, %s, %s, %s}" % (text.csa, text.s2, text.tf, text.s2f, text.ts),
        "m17:  {%s, %s, %s, %s, %s}" % (text.csa, text.s2, text.s2f, text.ts, text.rex),
        "m18:  {%s, %s, %s, %s, %s, %s}" % (text.csa, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "m19:  {%s, %s}" % (text.csa, text.rex),
        "",
        "tm10:  {%s, %s}" % (text.local_tm, text.csa),
        "tm11:  {%s, %s, %s}" % (text.local_tm, text.csa, text.s2),
        "tm12:  {%s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.te),
        "tm13:  {%s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.rex),
        "tm14:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.te, text.rex),
        "tm15:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.s2f, text.ts),
        "tm16:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.tf, text.s2f, text.ts),
        "tm17:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.s2f, text.ts, text.rex),
        "tm18:  {%s, %s, %s, %s, %s, %s, %s}" % (text.local_tm, text.csa, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "tm19:  {%s, %s, %s}" % (text.local_tm, text.csa, text.rex),
        "",
        "m20:  {%s}" % text.r,
        "m21:  {%s, %s}" % (text.r, text.s2),
        "m22:  {%s, %s, %s}" % (text.r, text.s2, text.te),
        "m23:  {%s, %s, %s}" % (text.r, text.s2, text.rex),
        "m24:  {%s, %s, %s, %s}" % (text.r, text.s2, text.te, text.rex),
        "m25:  {%s, %s, %s, %s}" % (text.r, text.s2, text.s2f, text.ts),
        "m26:  {%s, %s, %s, %s, %s}" % (text.r, text.s2, text.tf, text.s2f, text.ts),
        "m27:  {%s, %s, %s, %s, %s}" % (text.r, text.s2, text.s2f, text.ts, text.rex),
        "m28:  {%s, %s, %s, %s, %s, %s}" % (text.r, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "m29:  {%s, %s}" % (text.r, text.rex),
        "",
        "tm20:  {%s, %s}" % (text.local_tm, text.r),
        "tm21:  {%s, %s, %s}" % (text.local_tm, text.r, text.s2),
        "tm22:  {%s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.te),
        "tm23:  {%s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.rex),
        "tm24:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.te, text.rex),
        "tm25:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.s2f, text.ts),
        "tm26:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.tf, text.s2f, text.ts),
        "tm27:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.s2f, text.ts, text.rex),
        "tm28:  {%s, %s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "tm29:  {%s, %s, %s}" % (text.local_tm, text.r, text.rex),
        "",
        "m30:  {%s, %s}" % (text.r, text.csa),
        "m31:  {%s, %s, %s}" % (text.r, text.csa, text.s2),
        "m32:  {%s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.te),
        "m33:  {%s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.rex),
        "m34:  {%s, %s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.te, text.rex),
        "m35:  {%s, %s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.s2f, text.ts),
        "m36:  {%s, %s, %s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.tf, text.s2f, text.ts),
        "m37:  {%s, %s, %s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.s2f, text.ts, text.rex),
        "m38:  {%s, %s, %s, %s, %s, %s, %s}" % (text.r, text.csa, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "m39:  {%s, %s, %s}" % (text.r, text.csa, text.rex),
        "",
        "tm30:  {%s, %s, %s}" % (text.local_tm, text.r, text.csa),
        "tm31:  {%s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2),
        "tm32:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.te),
        "tm33:  {%s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.rex),
        "tm34:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.te, text.rex),
        "tm35:  {%s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.s2f, text.ts),
        "tm36:  {%s, %s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.tf, text.s2f, text.ts),
        "tm37:  {%s, %s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.s2f, text.ts, text.rex),
        "tm38:  {%s, %s, %s, %s, %s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.s2, text.tf, text.s2f, text.ts, text.rex),
        "tm39:  {%s, %s, %s, %s}" % (text.local_tm, text.r, text.csa, text.rex)
    ],
    wiz_combo_data = [
        "m0",
        "m1",
