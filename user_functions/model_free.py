...
uf.add_keyarg(
    ...
    wiz_combo_choices = [
        ...
        unicode("m4:  {S\u00B2, \u03C4e, Rex}"),
        unicode("m5:  {S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("m6:  {S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("m7:  {S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("m8:  {S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("m9:  {Rex}"),
        unicode(""),
        unicode("tm0:  {\u03C4m}"),
        unicode("tm1:  {\u03C4m, S\u00B2}"),
        unicode("tm2:  {\u03C4m, S\u00B2, \u03C4e}"),
        unicode("tm3:  {\u03C4m, S\u00B2, Rex}"),
        unicode("tm4:  {\u03C4m, S\u00B2, \u03C4e, Rex}"),
        unicode("tm5:  {\u03C4m, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("tm6:  {\u03C4m, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("tm7:  {\u03C4m, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm8:  {\u03C4m, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm9:  {\u03C4m, Rex}"),
        unicode(""),
        unicode("m10:  {CSA}"),
        unicode("m11:  {CSA, S\u00B2}"),
        unicode("m12:  {CSA, S\u00B2, \u03C4e}"),
        unicode("m13:  {CSA, S\u00B2, Rex}"),
        unicode("m14:  {CSA, S\u00B2, \u03C4e, Rex}"),
        unicode("m15:  {CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("m16:  {CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("m17:  {CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("m18:  {CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("m19:  {CSA, Rex}"),
        unicode(""),
        unicode("tm10:  {\u03C4m, CSA}"),
        unicode("tm11:  {\u03C4m, CSA, S\u00B2}"),
        unicode("tm12:  {\u03C4m, CSA, S\u00B2, \u03C4e}"),
        unicode("tm13:  {\u03C4m, CSA, S\u00B2, Rex}"),
        unicode("tm14:  {\u03C4m, CSA, S\u00B2, \u03C4e, Rex}"),
        unicode("tm15:  {\u03C4m, CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("tm16:  {\u03C4m, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("tm17:  {\u03C4m, CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm18:  {\u03C4m, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm19:  {\u03C4m, CSA, Rex}"),
        unicode(""),
        unicode("m20:  {r}"),
        unicode("m21:  {r, S\u00B2}"),
        unicode("m22:  {r, S\u00B2, \u03C4e}"),
        unicode("m23:  {r, S\u00B2, Rex}"),
        unicode("m24:  {r, S\u00B2, \u03C4e, Rex}"),
        unicode("m25:  {r, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("m26:  {r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("m27:  {r, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("m28:  {r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("m29:  {r, CSA, Rex}"),
        unicode(""),
        unicode("tm20:  {\u03C4m, r}"),
        unicode("tm21:  {\u03C4m, r, S\u00B2}"),
        unicode("tm22:  {\u03C4m, r, S\u00B2, \u03C4e}"),
        unicode("tm23:  {\u03C4m, r, S\u00B2, Rex}"),
        unicode("tm24:  {\u03C4m, r, S\u00B2, \u03C4e, Rex}"),
        unicode("tm25:  {\u03C4m, r, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("tm26:  {\u03C4m, r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("tm27:  {\u03C4m, r, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm28:  {\u03C4m, r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm29:  {\u03C4m, r, CSA, Rex}"),
        unicode(""),
        unicode("m30:  {r, CSA}"),
        unicode("m31:  {r, CSA, S\u00B2}"),
        unicode("m32:  {r, CSA, S\u00B2, \u03C4e}"),
        unicode("m33:  {r, CSA, S\u00B2, Rex}"),
        unicode("m34:  {r, CSA, S\u00B2, \u03C4e, Rex}"),
        unicode("m35:  {r, CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("m36:  {r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("m37:  {r, CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("m38:  {r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("m39:  {r, CSA, Rex}"),
        unicode(""),
        unicode("tm30:  {\u03C4m, r, CSA}"),
        unicode("tm31:  {\u03C4m, r, CSA, S\u00B2}"),
        unicode("tm32:  {\u03C4m, r, CSA, S\u00B2, \u03C4e}"),
        unicode("tm33:  {\u03C4m, r, CSA, S\u00B2, Rex}"),
        unicode("tm34:  {\u03C4m, r, CSA, S\u00B2, \u03C4e, Rex}"),
        unicode("tm35:  {\u03C4m, r, CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        unicode("tm36:  {\u03C4m, r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        unicode("tm37:  {\u03C4m, r, CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm38:  {\u03C4m, r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        unicode("tm39:  {\u03C4m, r, CSA, Rex}")
    ],
    wiz_combo_data = [
        "m0",
        "m1",
