...
uf.add_keyarg(
    ...
    wiz_combo_choices = [
        ...
        u("tm4:  {\u03C4\u2098, S\u00B2, \u03C4e, Rex}"),
        u("tm5:  {\u03C4\u2098, S\u00B2f, S\u00B2, \u03C4s}"),
        u("tm6:  {\u03C4\u2098, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        u("tm7:  {\u03C4\u2098, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        u("tm8:  {\u03C4\u2098, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        u("tm9:  {\u03C4\u2098, Rex}"),
        u(""),
        u("m10:  {CSA}"),
        u("m11:  {CSA, S\u00B2}"),
        ...
        u("tm12:  {\u03C4\u2098, CSA, S\u00B2, \u03C4e}"),
        u("tm13:  {\u03C4\u2098, CSA, S\u00B2, Rex}"),
        u("tm14:  {\u03C4\u2098, CSA, S\u00B2, \u03C4e, Rex}"),
        u("tm15:  {\u03C4\u2098, CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        u("tm16:  {\u03C4\u2098, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        u("tm17:  {\u03C4\u2098, CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        u("tm18:  {\u03C4\u2098, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        u("tm19:  {\u03C4\u2098, CSA, Rex}"),
        u(""),
        u("m20:  {r}"),
        u("m21:  {r, S\u00B2}"),
        ...
        u("tm22:  {\u03C4\u2098, r, S\u00B2, \u03C4e}"),
        u("tm23:  {\u03C4\u2098, r, S\u00B2, Rex}"),
        u("tm24:  {\u03C4\u2098, r, S\u00B2, \u03C4e, Rex}"),
        u("tm25:  {\u03C4\u2098, r, S\u00B2f, S\u00B2, \u03C4s}"),
        u("tm26:  {\u03C4\u2098, r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        u("tm27:  {\u03C4\u2098, r, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        u("tm28:  {\u03C4\u2098, r, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        u("tm29:  {\u03C4\u2098, r, CSA, Rex}"),
        u(""),
        u("m30:  {r, CSA}"),
        u("m31:  {r, CSA, S\u00B2}"),
        ...
        u("tm30:  {\u03C4\u2098, r, CSA}"),
        u("tm31:  {\u03C4\u2098, r, CSA, S\u00B2}"),
        u("tm32:  {\u03C4\u2098, r, CSA, S\u00B2, \u03C4e}"),
        u("tm33:  {\u03C4\u2098, r, CSA, S\u00B2, Rex}"),
        u("tm34:  {\u03C4\u2098, r, CSA, S\u00B2, \u03C4e, Rex}"),
        u("tm35:  {\u03C4\u2098, r, CSA, S\u00B2f, S\u00B2, \u03C4s}"),
        u("tm36:  {\u03C4\u2098, r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s}"),
        u("tm37:  {\u03C4\u2098, r, CSA, S\u00B2f, S\u00B2, \u03C4s, Rex}"),
        u("tm38:  {\u03C4\u2098, r, CSA, S\u00B2f, \u03C4f, S\u00B2, \u03C4s, Rex}"),
        u("tm39:  {\u03C4\u2098, r, CSA, Rex}")
    ],
    wiz_combo_data = [
        "m0",
