...
uf.add_keyarg(
    ...
    wiz_combo_choices = [
        ...
        "%s: {R20, ..., pA, dw, kex}" % MODEL_NS_CPMG_2SITE_3D,
        "%s: {R20A, R20B, ..., pA, dw, kex}" % MODEL_NS_CPMG_2SITE_3D_FULL,
        "%s: {R20, ..., pA, dw, kex}" % MODEL_NS_CPMG_2SITE_STAR,
        "%s: {R20A, R20B, ..., pA, dw, kex}" % MODEL_NS_CPMG_2SITE_STAR_FULL,
        "%s: {R20, ..., pA, dw, kex}" % MODEL_NS_CPMG_2SITE_EXPANDED,
