...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_NOREX_R1RHO_FIT_R1, "This is the model for no chemical exchange being present, for off-resonance R1rho-type experiments whereby R1 is fitted.  R1rho = R1 * cos(theta)^2 + r1rho_prime * sin(theta)^2")
# CPMG-type data.
...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_DPL94_FIT_R1, "The Davis, Perlman and London (1994) 2-site fast exchange equation, whereby R1 is fitted, with parameters {R1rho', R1, ..., phi_ex, kex},")
...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_TP02_FIT_R1, "The Trott and Palmer (2002) 2-site equation for all time scales, whereby R1 is fitted, with parameters {R1rho', R1, ..., pA, dw, kex}.")
...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_TAP03_FIT_R1, "The Trott, Abergel and Palmer (2003) off-resonance 2-site equation for all time scales, whereby R1 is fitted, with parameters {R1rho', R1, ..., pA, dw, kex}.")
...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_MP05_FIT_R1, "The Miloushev and Palmer (2005) 2-site off-resonance equation for all time scales, whereby R1 is fitted, with parameters {R1rho', R1, ..., pA, dw, kex}.")
uf.desc[-1].add_paragraph("The currently supported numeric models are:")
...
uf.desc[-1].add_item_list_element("'%s'" % MODEL_NS_R1RHO_2SITE_FIT_R1, "The numerical solution for the 2-site Bloch-McConnell equations using 3D magnetisation vectors whereby the simplification R20A = R20B and whereby R1 is fitted.  Its parameters are {R1rho', R1, ..., pA, dw, kex}.")
