...
table = uf_tables.add_table(title="Minimisation algorithms -- unconstrained line search methods.", label="table: min - line search")
...
table = uf_tables.add_table(title="Minimisation algorithms -- unconstrained trust-region methods.", label="table: min - trust-region")
table.add_headings(["Minimisation algorithm", "Patterns"])
...
table = uf_tables.add_table(title="Minimisation algorithms -- unconstrained conjugate gradient methods.", label="table: min - conjugate gradient")
table.add_headings(["Minimisation algorithm", "Patterns"])
...
table = uf_tables.add_table(title="Minimisation algorithms -- miscellaneous unconstrained methods.", label="table: min - misc")
table.add_headings(["Minimisation algorithm", "Patterns"])
...
table = uf_tables.add_table(title="Minimisation algorithms -- global minimisation methods.", label="table: min - global")
table.add_headings(["Minimisation algorithm", "Patterns"])
...
table = uf_tables.add_table(title="Minimisation sub-algorithms -- line search algorithms.", label="table: min sub-algor - line search")
...
table = uf_tables.add_table(title="Minimisation sub-algorithms -- Hessian modifications.", label="table: min sub-algor - Hessian mod")
...
table = uf_tables.add_table(title="Minimisation sub-algorithms -- Hessian type.", label="table: min sub-algor - Hessian type")
