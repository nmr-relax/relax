...
def single(num_spins=1, model=MODEL_NS_R1RHO_3SITE_LINEAR, iter=None):
    ...
    # Instantiate class
    C1 = Profile(num_spins=num_spins, model=model, r2=5.0, dw_AB=1.0, dw_BC=2.0, pA=0.8, kex_AB=5000.0, pB=0.1, kex_BC=3000.0, spins_params=['r2', 'dw_AB', 'dw_BC', 'pA', 'kex_AB', 'pB', 'kex_BC'])
