...
class Profile(Dispersion):
    ...
    def return_r2eff_arrays(self):
        ...
        if self.model in [MODEL_B14_FULL, MODEL_NS_CPMG_2SITE_3D, MODEL_NS_CPMG_2SITE_3D_FULL, MODEL_NS_CPMG_2SITE_STAR_FULL]:
...
def test_reshape():
    C1 = Profile(num_spins=1, model=MODEL_NS_CPMG_2SITE_3D, r2a=5.0, r2b=10.0, dw=3.0, pA=0.9, kex=1000.0, spins_params=['r2a', 'r2b', 'dw', 'pA', 'kex'])
