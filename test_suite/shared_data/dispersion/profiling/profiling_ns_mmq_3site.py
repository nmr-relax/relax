...
class Profile(Dispersion):
    ...
    def calc(self, params):
        ...
        # Return chi2 value.
        chi2 = self.model.func_ns_mmq_3site(params)
        return chi2


def single(num_spins=1, model=MODEL_NS_MMQ_3SITE, iter=None):
    ...
    # Instantiate class
    C1 = Profile(num_spins=num_spins, model=model, r2=5.0, dw_AB=1.0, dw_BC=2.0, dwH_AB=0.01, dwH_BC=0.02, pA=0.8, kex_AB=5000.0, pB=0.1, kex_BC=3000.0, kex_AC=1000.0, spins_params=['r2', 'dw_AB', 'dw_BC', 'dwH_AB', 'dwH_BC', 'pA', 'kex_AB', 'pB', 'kex_BC', 'kex_AC'])
...
def cluster(num_spins=100, model=MODEL_NS_MMQ_3SITE, iter=None):
