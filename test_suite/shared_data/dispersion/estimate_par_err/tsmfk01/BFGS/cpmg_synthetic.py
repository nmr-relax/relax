...
if not hasattr(ds, 'data'):
    ...
    # Add more spins here.
    spins = [
            ['Ala', 1, 'N', {'r2': {r20_key_1: 25.0, r20_key_2: 24.0}, 'r2a': {r20_key_1: 12.0, r20_key_2: 10.0}, 'r2b': {r20_key_1: 25.0, r20_key_2: 24.0}, 'k_AB': 11.0, 'dw': 5.0}]
            #['Ala', 2, 'N', {'r2': {r20_key_1: 15.0, r20_key_2: 14.0}, 'r2a': {r20_key_1: 11.0, r20_key_2: 12.0}, 'r2b': {r20_key_1: 15.0, r20_key_2: 14.0}, 'k_AB': 11.0, 'dw': 7.0}],
            ]
...
#state.save(state='final_state', dir=ds.resdir, force=True)
...
minimise.execute(min_algor=min_algor, constraints=constraints)
eliminate()
monte_carlo.error_analysis()

#state.save(state='final_state_mc%i', dir=ds.resdir, force=True)
results.write(file='final_results_mc', dir=ds.resdir, force=True)
