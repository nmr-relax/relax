...
$ rm -f cpmg_fit_solution_cr72.log; ../../../../../relax --tee cpmg_fit_solution_cr72.log cpmg_fit_solution_cr72.py
...
# Change the model.
relax_disp.select_model('MQ CR72')
...
move('disp_9_N.agr', 'cpmg_fit_solution_cr72.agr')
