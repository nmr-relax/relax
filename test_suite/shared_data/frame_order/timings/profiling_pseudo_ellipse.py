...
rdc.read(align_id='dy', file='rdc_dy.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', data_type='D', spin_id1_col=1, spin_id2_col=2, data_col=3, error_col=4, sep=None, neg_g_corr=False, absolute=False)
pcs.read(align_id='dy', file='pcs_dy.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', spin_id_col=None, mol_name_col=1, res_num_col=2, res_name_col=None, spin_num_col=None, spin_name_col=5, data_col=6, error_col=7, sep=None, spin_id=None)
spectrometer.temperature(id='dy', temp=303)
spectrometer.frequency(id='dy', frq=900000000.0, units='Hz')
rdc.read(align_id='tb', file='rdc_tb.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', data_type='D', spin_id1_col=1, spin_id2_col=2, data_col=3, error_col=4, sep=None, neg_g_corr=False, absolute=False)
pcs.read(align_id='tb', file='pcs_tb.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', spin_id_col=None, mol_name_col=1, res_num_col=2, res_name_col=None, spin_num_col=None, spin_name_col=5, data_col=6, error_col=7, sep=None, spin_id=None)
spectrometer.temperature(id='tb', temp=303)
spectrometer.frequency(id='tb', frq=900000000.0, units='Hz')
rdc.read(align_id='tm', file='rdc_tm.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', data_type='D', spin_id1_col=1, spin_id2_col=2, data_col=3, error_col=4, sep=None, neg_g_corr=False, absolute=False)
pcs.read(align_id='tm', file='pcs_tm.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', spin_id_col=None, mol_name_col=1, res_num_col=2, res_name_col=None, spin_num_col=None, spin_name_col=5, data_col=6, error_col=7, sep=None, spin_id=None)
spectrometer.temperature(id='tm', temp=303)
spectrometer.frequency(id='tm', frq=900000000.0, units='Hz')
rdc.read(align_id='er', file='rdc_er.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', data_type='D', spin_id1_col=1, spin_id2_col=2, data_col=3, error_col=4, sep=None, neg_g_corr=False, absolute=False)
pcs.read(align_id='er', file='pcs_er.txt', dir='/data/relax/branches/frame_order_cleanup/test_suite/shared_data/frame_order/cam/pseudo_ellipse', spin_id_col=None, mol_name_col=1, res_num_col=2, res_name_col=None, spin_num_col=None, spin_name_col=5, data_col=6, error_col=7, sep=None, spin_id=None)
...
value.set(val=3.141592653589793, param='eigen_alpha', index=0, spin_id=None, error=False)
value.set(val=0.9600799785953431, param='eigen_beta', index=0, spin_id=None, error=False)
value.set(val=4.032275506219623, param='eigen_gamma', index=0, spin_id=None, error=False)
value.set(val=0.5235987755982988, param='cone_theta_x', index=0, spin_id=None, error=False)
value.set(val=0.8726646259971648, param='cone_theta_y', index=0, spin_id=None, error=False)
value.set(val=1.0471975511965976, param='cone_sigma_max', index=0, spin_id=None, error=False)
