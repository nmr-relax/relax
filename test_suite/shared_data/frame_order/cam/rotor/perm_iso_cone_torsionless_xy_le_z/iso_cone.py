...
pipe_name = 'iso cone, torsionless'
tag = ''
for perm in [None, 'A']:
    ...
    if perm == None:
        ...
        pipe.copy(pipe_from='frame order', pipe_to='iso cones')
        pipe.switch(pipe_name='iso cones')
    ...
    # Operations for the 'A' and 'B' permutations.
        ...
        pipe_name = 'iso cone, torsionless perm %s' % perm
        tag = '_perm_%s' % perm
