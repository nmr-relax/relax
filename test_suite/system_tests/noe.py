###############################################################################
#                                                                             #
# Copyright (C) 2006-2008,2011-2015 Edward d'Auvergne                         #
#                                                                             #
...
class Noe(SystemTestCase):
    ...
    def test_noe_analysis(self):
        ...
        data = [[
            ...
            '@target G0.S0\n',
            '@type xydy\n',
            '             4.000000000000000         148614.000000000000000           3600.000000000000000\n',
            '             5.000000000000000         166842.000000000000000         122000.000000000000000\n',
            '             6.000000000000000         128690.000000000000000           3600.000000000000000\n',
            '            40.000000000000000          99566.000000000000000           3600.000000000000000\n',
            '            40.000000000000000         270047.000000000000000           3600.000000000000000\n',
            '            55.000000000000000         130959.000000000000000           3600.000000000000000\n',
            '&\n',
            '@target G0.S1\n',
            '@type xydy\n',
            '             4.000000000000000           5050.000000000000000           3000.000000000000000\n',
            '             5.000000000000000          51643.000000000000000           8500.000000000000000\n',
            '             6.000000000000000          53663.000000000000000           3000.000000000000000\n',
            '            40.000000000000000         -65111.000000000000000           3000.000000000000000\n',
            '            40.000000000000000        -181131.000000000000000           3000.000000000000000\n',
            '            55.000000000000000        -105322.000000000000000           3000.000000000000000\n',
            '&\n',
            '@with g0\n',
            '@autoscale\n'
        ], [
            ...
            '@target G0.S0\n',
            '@type xydy\n',
            '             4.000000000000000              0.033980647852827              0.020203299032766\n',
            '             5.000000000000000              0.309532371944714              0.232002467165734\n',
            '             6.000000000000000              0.416994327453571              0.026067523940085\n',
            '            40.000000000000000             -0.653948134905490              0.038300618865379\n',
            '            55.000000000000000             -0.804236440412648              0.031836147771836\n',
            '&\n',
            '@target G0.S1\n',
            '@type xydy\n',
            '            40.000000000000000             -0.670738797320466              0.014260663438353\n',
            '&\n',
            '@with g0\n',
            '@autoscale\n'
        ]]
