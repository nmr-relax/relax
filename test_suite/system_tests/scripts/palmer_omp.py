###############################################################################
#                                                                             #
# Copyright (C) 2003-2005,2008-2009,2012 Edward d'Auvergne                    #
...
def exec_stage_1(pipes):
    ...
    for name in pipes:
        ...
        # Read a PDB file.
        structure.read_pdb(file='1F35_N_H_trunc.pdb', dir=status.install_path + sep+'test_suite'+sep+'shared_data'+sep+'structures')
