...
sequence.display()
structure.read_pdb(file='tylers_peptide_trunc.pdb', dir=DATA_PATH+'structures', model=None, parser='scientific')
structure.vectors(attached='H', spin_id=None, struct_index=None, verbosity=1, ave=True, unit=True)
