...
bmrb.script(file='relax_fit.py', dir=sys.path[-1]+sep+'sample_scripts', analysis_type='relaxation curve fitting', engine='relax')
bmrb.script(file='full_analysis.py', dir=sys.path[-1]+sep+'sample_scripts', analysis_type='model-free', model_selection='AIC', engine='relax', model_elim=True, universal_solution=True)
