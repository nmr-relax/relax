###############################################################################
#                                                                             #
# Copyright (C) 2006,2008,2011,2013 Edward d'Auvergne                         #
#                                                                             #
...
grace.write(x_data_type='relax_times', y_data_type='peak_intensity', file='curves.agr', dir=ds.tmpdir, force=True)    # Average peak intensities.
grace.write(x_data_type='relax_times', y_data_type='peak_intensity', norm=True, file='curves_norm.agr', dir=ds.tmpdir, force=True)    # Average peak intensities (normalised).
grace.write(x_data_type='res_num', y_data_type='peak_intensity', file='intensities.agr', dir=ds.tmpdir, force=True)    # Average peak intensities.
...
grace.write(x_data_type='peak_intensity', y_data_type='relax_times', file='curves_rev.agr', dir=ds.tmpdir, force=True)    # Average peak intensities.
grace.write(x_data_type='peak_intensity', y_data_type='relax_times', norm=True, file='curves_norm_rev.agr', dir=ds.tmpdir, force=True)    # Average peak intensities (normalised).
grace.write(x_data_type='peak_intensity', y_data_type='res_num', file='intensities_rev.agr', dir=ds.tmpdir, force=True)    # Average peak intensities.
