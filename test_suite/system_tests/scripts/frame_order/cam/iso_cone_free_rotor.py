# Script for optimising the ico cone, free rotor frame order test model of CaM.
...
class Analysis:
    ...
    def optimisation(self):
        ...
        self._execute_uf(uf_name='value.set', val=0.0, param='axis_theta')
        self._execute_uf(uf_name='value.set', val=0.0, param='axis_phi')
        self._execute_uf(uf_name='value.set', val=0.4375, param='cone_s1')
