...
class Analysis:
    ...
    def optimisation(self):
        ...
        self._execute_uf(uf_name='value.set', val=2.0944, param='ave_pos_alpha')
        ...
        self._execute_uf(uf_name='value.set', val=0.0, param='eigen_alpha')
        self._execute_uf(uf_name='value.set', val=0.0, param='eigen_beta')
        self._execute_uf(uf_name='value.set', val=0.0, param='eigen_gamma')
        self._execute_uf(uf_name='value.set', val=1.0472, param='cone_sigma_max')
