...
class Analysis:
    ...
    def optimisation(self):
        ...
        self._execute_uf(uf_name='value.set', val=2.2143, param='ave_pos_beta')
        self._execute_uf(uf_name='value.set', val=0.897, param='ave_pos_gamma')
        self._execute_uf(uf_name='value.set', val=1.570, param='axis_theta')
        self._execute_uf(uf_name='value.set', val=1.1968, param='axis_phi')
