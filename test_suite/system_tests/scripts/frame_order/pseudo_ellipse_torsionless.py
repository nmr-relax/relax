...
self._execute_uf(uf_name='pipe.create', pipe_name='cone_10.0_deg', pipe_type='frame order')
...
self._execute_uf(uf_name='align_tensor.init', tensor='0 red', params=(4.1928305040232923e-05, -0.00024816393447774771, 3.6780458433909605e-05, 0.00030765727807373372, 0.000505113131281731), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='1 red', params=(0.00035318252278541365, -0.00021730679174203522, 0.00012745273432245843, -6.1892675665283241e-05, 0.00028308583415867804), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='2 red', params=(0.00030442395642681688, -0.00016574192421895623, 0.00016121304073767043, 2.6872263264857674e-05, 0.00027725900587550269), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='3 red', params=(2.9032002897450694e-05, -0.00020353906604090533, -2.502544147318107e-06, -0.00015629310319956421, 0.00011361328961968405), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='4 red', params=(-0.00023144600971694294, 0.00049253613415984167, 0.00013225777158284313, -0.00014789012108164197, -5.0559773565140074e-05), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='5 red', params=(3.2495051593361988e-05, -0.00011385069381789637, 0.00029244761843852238, -0.00042527326469032933, 1.7451234900187253e-05), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='6 red', params=(-2.3929791875631606e-06, -0.00017148761169242068, -0.00015254335318618472, -6.5524728340230458e-05, 3.7387729651318057e-05), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='7 red', params=(0.0004354742828296894, -0.00045886465127317012, -4.1394323973756964e-05, -9.3122585297347339e-05, 0.00040194180996246646), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='8 red', params=(0.00052293463339829656, -0.00047818836932657718, 0.00015548236464101787, 3.4736591775716531e-05, -0.0001407446227327215), param_types=0)
...
self._execute_uf(uf_name='align_tensor.init', tensor='9 red', params=(-0.00014323204337253625, -0.00017060313528794281, 4.4392870134304945e-06, 0.00015974878413755982, 8.8632998317901221e-05), param_types=0)
