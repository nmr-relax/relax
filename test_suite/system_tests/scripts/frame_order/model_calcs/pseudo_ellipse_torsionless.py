...
# Load the tensors.
script(status.install_path + sep+'test_suite'+sep+'system_tests'+sep+'scripts'+sep+'frame_order'+sep+'tensors'+sep+'pseudo_ellipse_torsionless_out_of_frame_theta_x_tensors_beta168_75.py')
