...
class Test_mp05(TestCase):
    ...
    def calc_r1rho(self):
        ...
        R1rho = r1rho_MP05(r1rho_prime=self.r1rho_prime, omega=self.omega, offset=self.offset, pA=self.pA, pB=pB, dw=dw_frq, kex=self.kex, R1=self.r1, spin_lock_fields=spin_lock_omega1, spin_lock_fields2=spin_lock_omega1_squared, back_calc=self.R1rho, num_points=self.num_points)
    ...
    def test_mp05_no_rex4(self):
        """Test the r1rho_mp05() function for no exchange when dw = 0.0 and pA = 1.0."""
    ...
    def test_mp05_no_rex5(self):
        """Test the r1rho_mp05() function for no exchange when dw = 0.0 and kex = 0.0."""
    ...
    def test_mp05_no_rex6(self):
        """Test the r1rho_mp05() function for no exchange when pA = 1.0 and kex = 0.0."""
    ...
    def test_mp05_no_rex7(self):
        """Test the r1rho_mp05() function for no exchange when dw = 0.0, pA = 1.0, and kex = 0.0."""
