...
class Test_select(TestCase):
    ...
    def test_read_argfail_dir(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.select_fns.read, file='unresolved', dir=data[1])
    ...
    def test_read_argfail_mol_name_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxIntError, self.select_fns.read, file='unresolved', mol_name_col=data[1])
    ...
    def test_read_argfail_res_num_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxIntError, self.select_fns.read, file='unresolved', res_num_col=data[1])
    ...
    def test_read_argfail_res_name_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxIntError, self.select_fns.read, file='unresolved', res_name_col=data[1])
    ...
    def test_read_argfail_spin_num_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxIntError, self.select_fns.read, file='unresolved', spin_num_col=data[1])
    ...
    def test_read_argfail_spin_name_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxIntError, self.select_fns.read, file='unresolved', spin_name_col=data[1])
    ...
    def test_read_argfail_sep(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.select_fns.read, file='unresolved', sep=data[1])
    ...
    def test_reverse_argfail_spin_id(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.select_fns.reverse, spin_id=data[1])
    ...
    def test_spin_argfail_spin_id(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.select_fns.spin, spin_id=data[1])
