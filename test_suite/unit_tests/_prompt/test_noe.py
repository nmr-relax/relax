...
class Test_noe(TestCase):
    ...
    def test_read_argfail_dir(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneStrError, self.noe_fns.read, file='noes', dir=data[1])
    ...
    def test_read_argfail_proton1_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneIntError, self.noe_fns.read, file='noes', proton1_col=data[1])
    ...
    def test_read_argfail_proton2_col(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneIntError, self.noe_fns.read, file='noes', proton2_col=data[1])
    ...
    def test_read_argfail_sep(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneStrError, self.noe_fns.read, file='noes', sep=data[1])
