...
from lib.errors import RelaxError, RelaxBoolError, RelaxIntError, RelaxStrError, RelaxStrFileError
...
class Test_sequence(Sequence_base_class, TestCase):
    ...
    def test_read_argfail_file(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrFileError, self.sequence_fns.read, file=data[1])
    ...
    def test_write_argfail_file(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrFileError, self.sequence_fns.write, file=data[1])
