###############################################################################
#                                                                             #
# Copyright (C) 2009,2011-2012 Edward d'Auvergne                              #
#                                                                             #
...
class Test_molmol(TestCase):
    ...
    def test_macro_apply_argfail_colour_start_name(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.molmol_fns.macro_apply, data_type='a', style='x', colour_start_name=data[1])
    ...
    def test_macro_apply_argfail_colour_start_rgb(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxListNumError, self.molmol_fns.macro_apply, data_type='a', style='x', colour_start_rgb=data[1])
    ...
    def test_macro_apply_argfail_colour_end_name(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.molmol_fns.macro_apply, data_type='a', style='x', colour_end_name=data[1])
    ...
    def test_macro_apply_argfail_colour_end_rgb(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxListNumError, self.molmol_fns.macro_apply, data_type='a', style='x', colour_end_rgb=data[1])
    ...
    def test_macro_apply_argfail_colour_list(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.molmol_fns.macro_apply, data_type='a', style='x', colour_list=data[1])
