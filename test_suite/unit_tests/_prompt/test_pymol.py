...
class Test_pymol(TestCase):
    ...
    def test_macro_exec_argfail_data_type(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.pymol_fns.macro_exec, data_type=data[1])
    ...
    def test_macro_exec_argfail_style(self):
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxStrError, self.pymol_fns.macro_exec, data_type='a', style=data[1])


    def test_macro_exec_argfail_colour_start(self):
        """The colour_start arg test of the pymol.macro_exec() user function."""
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneStrListNumError, self.pymol_fns.macro_exec, data_type='a', style='x', colour_start=data[1])


    def test_macro_exec_argfail_colour_end(self):
        """The colour_end arg test of the pymol.macro_exec() user function."""
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneStrListNumError, self.pymol_fns.macro_exec, data_type='a', style='x', colour_end=data[1])


    def test_macro_exec_argfail_colour_list(self):
        """The colour_list arg test of the pymol.macro_exec() user function."""
        ...
        for data in DATA_TYPES:
            ...
            # The argument test.
            self.assertRaises(RelaxNoneStrError, self.pymol_fns.macro_exec, data_type='a', style='x', colour_list=data[1])
