...
class RelaxTestResult(TextTestResult):
    ...
    def __init__(self, stream, descriptions, verbosity, category=None, timing=False, io_capture=True):
        ...
        @param descriptions:    A flag which if True will cause the test description to be printed out, when the verbosity is > 1.
