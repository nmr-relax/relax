...
class select_tensor(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.sphere_button = wx.BitmapButton(self, -1, wx.Bitmap(sys.path[-1]+sep+'gui_bieri'+sep+'images'+sep+'sphere.jpg', wx.BITMAP_TYPE_ANY))
        self.label_9_copy_copy_copy = wx.StaticText(self, -1, "Prolate")
        self.oblate_button = wx.BitmapButton(self, -1, wx.Bitmap(sys.path[-1]+sep+'gui_bieri'+sep+'images'+sep+'prolate.jpg', wx.BITMAP_TYPE_ANY))
        self.label_10_copy_copy_copy = wx.StaticText(self, -1, "Oblate")
        self.prolate_button = wx.BitmapButton(self, -1, wx.Bitmap(sys.path[-1]+sep+'gui_bieri'+sep+'images'+sep+'oblate.jpg', wx.BITMAP_TYPE_ANY))
        self.label_11_copy_copy_copy = wx.StaticText(self, -1, "Ellipsoid")
        self.ellipsoid_button = wx.BitmapButton(self, -1, wx.Bitmap(sys.path[-1]+sep+'gui_bieri'+sep+'images'+sep+'ellipsoid.jpg', wx.BITMAP_TYPE_ANY))
