...
class load(generic_functions):
	...
	def relax_data(self, ri_label=None, frq_label=None, frq=None, file_name=None, num_col=0, name_col=1, data_col=2, error_col=3, sep=None):
		...
		>>> load_relax_data('R2', '800', 8.0 * 1e8, 'r2.out', 1, 2, 4, 5, ',')
		>>> load_relax_data(ri_label='R2', frq_label='800', frq=8.0*1e8, file_name='r2.out', num_col=1, name_col=2, data_col=4, error_col=5, sep=','):
